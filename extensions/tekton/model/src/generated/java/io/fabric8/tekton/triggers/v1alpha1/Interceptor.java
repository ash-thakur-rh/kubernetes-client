...
public class Interceptor implements Editable<InterceptorBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("spec")
    private InterceptorSpec spec;
    @JsonProperty("status")
    private InterceptorStatus status;
    @JsonIgnore
    ...
    public Interceptor(String apiVersion, String kind, ObjectMeta metadata, InterceptorSpec spec, InterceptorStatus status) {
        super();
    ...
    @JsonIgnore
    public InterceptorBuilder edit() {
        return new InterceptorBuilder(this);
    }

    @JsonIgnore
    public InterceptorBuilder toBuilder() {
        return edit();
    }
