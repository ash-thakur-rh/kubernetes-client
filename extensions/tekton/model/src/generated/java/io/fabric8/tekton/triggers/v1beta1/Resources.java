...
public class Resources implements Editable<ResourcesBuilder>, KubernetesResource
{
    ...
    public Resources(CustomResource customResource, io.fabric8.tekton.triggers.v1beta1.KubernetesResource kubernetesResource) {
        super();
    ...
    @JsonProperty("kubernetesResource")
    public io.fabric8.tekton.triggers.v1beta1.KubernetesResource getKubernetesResource() {
        return kubernetesResource;
    }

    @JsonProperty("kubernetesResource")
    public void setKubernetesResource(io.fabric8.tekton.triggers.v1beta1.KubernetesResource kubernetesResource) {
        this.kubernetesResource = kubernetesResource;
    }
