...
public class ClusterTriggerBinding implements Editable<ClusterTriggerBindingBuilder>, HasMetadata
{
    ...
    public ClusterTriggerBinding(String apiVersion, String kind, ObjectMeta metadata, TriggerBindingSpec spec, TriggerBindingStatus status) {
        super();
    ...
    @JsonIgnore
    public ClusterTriggerBindingBuilder edit() {
        return new ClusterTriggerBindingBuilder(this);
    }

    @JsonIgnore
    public ClusterTriggerBindingBuilder toBuilder() {
        return edit();
    }
