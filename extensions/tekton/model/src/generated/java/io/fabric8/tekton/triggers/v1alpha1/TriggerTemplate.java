...
public class TriggerTemplate implements Editable<TriggerTemplateBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("kind")
    private String kind = "TriggerTemplate";
    ...
    public TriggerTemplate(String apiVersion, String kind, ObjectMeta metadata, TriggerTemplateSpec spec, TriggerTemplateStatus status) {
        super();
     ...
     */
    @JsonProperty("status")
    public TriggerTemplateStatus getStatus() {
        return status;
    }
