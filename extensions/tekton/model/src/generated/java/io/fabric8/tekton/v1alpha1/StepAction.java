...
public class StepAction implements Editable<StepActionBuilder>, HasMetadata, Namespaced
{
    ...
    public StepAction(String apiVersion, String kind, ObjectMeta metadata, StepActionSpec spec) {
        super();
     ...
     */
    @JsonProperty("spec")
    public void setSpec(StepActionSpec spec) {
        this.spec = spec;
    }

    @JsonIgnore
    public StepActionBuilder edit() {
        return new StepActionBuilder(this);
    }

    @JsonIgnore
    public StepActionBuilder toBuilder() {
        return edit();
    }
