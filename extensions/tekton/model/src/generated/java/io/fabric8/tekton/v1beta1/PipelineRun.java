...
public class PipelineRun implements Editable<PipelineRunBuilder>, HasMetadata, Namespaced
{
    ...
    public PipelineRun(String apiVersion, String kind, ObjectMeta metadata, PipelineRunSpec spec, PipelineRunStatus status) {
        super();
    ...
    @JsonIgnore
    public PipelineRunBuilder edit() {
        return new PipelineRunBuilder(this);
    }

    @JsonIgnore
    public PipelineRunBuilder toBuilder() {
        return edit();
    }
