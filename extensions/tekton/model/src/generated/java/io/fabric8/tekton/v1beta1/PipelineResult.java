...
public class PipelineResult implements Editable<PipelineResultBuilder>, KubernetesResource
{
    ...
    @JsonIgnore
    public PipelineResultBuilder edit() {
        return new PipelineResultBuilder(this);
    }

    @JsonIgnore
    public PipelineResultBuilder toBuilder() {
        return edit();
    }
