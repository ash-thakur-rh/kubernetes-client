...
public class InterceptorRef implements Editable<InterceptorRefBuilder>, KubernetesResource
{
    ...
    @JsonIgnore
    public InterceptorRefBuilder edit() {
        return new InterceptorRefBuilder(this);
    }

    @JsonIgnore
    public InterceptorRefBuilder toBuilder() {
        return edit();
    }
