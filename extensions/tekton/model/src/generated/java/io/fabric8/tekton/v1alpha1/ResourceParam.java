...
public class ResourceParam implements Editable<ResourceParamBuilder>, KubernetesResource
{
    ...
    @JsonIgnore
    public ResourceParamBuilder edit() {
        return new ResourceParamBuilder(this);
    }

    @JsonIgnore
    public ResourceParamBuilder toBuilder() {
        return edit();
    }
