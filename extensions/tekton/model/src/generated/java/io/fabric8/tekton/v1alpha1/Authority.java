...
public class Authority implements Editable<AuthorityBuilder>, KubernetesResource
{
    ...
    public Authority(KeyRef key, String name) {
        super();
        this.key = key;
        this.name = name;
    }
    ...
    @JsonIgnore
    public AuthorityBuilder edit() {
        return new AuthorityBuilder(this);
    }

    @JsonIgnore
    public AuthorityBuilder toBuilder() {
        return edit();
    }
