...
public class EmbeddedRunSpec implements Editable<EmbeddedRunSpecBuilder>, KubernetesResource
{
    ...
    public EmbeddedRunSpec(String apiVersion, String kind, PipelineTaskMetadata metadata, Object spec) {
        super();
    ...
    @JsonIgnore
    public EmbeddedRunSpecBuilder edit() {
        return new EmbeddedRunSpecBuilder(this);
    }

    @JsonIgnore
    public EmbeddedRunSpecBuilder toBuilder() {
        return edit();
    }
