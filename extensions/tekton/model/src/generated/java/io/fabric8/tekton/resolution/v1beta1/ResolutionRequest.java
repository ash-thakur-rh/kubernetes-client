...
public class ResolutionRequest implements Editable<ResolutionRequestBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("status")
    private ResolutionRequestStatus status;
    @JsonIgnore
     ...
     */
    @JsonProperty("spec")
    public ResolutionRequestSpec getSpec() {
        return spec;
    }
     ...
     */
    @JsonProperty("spec")
    public void setSpec(ResolutionRequestSpec spec) {
        this.spec = spec;
    }
     ...
     */
    @JsonProperty("status")
    public ResolutionRequestStatus getStatus() {
        return status;
    }
     ...
     */
    @JsonProperty("status")
    public void setStatus(ResolutionRequestStatus status) {
        this.status = status;
    }

    @JsonIgnore
    public ResolutionRequestBuilder edit() {
        return new ResolutionRequestBuilder(this);
    }

    @JsonIgnore
    public ResolutionRequestBuilder toBuilder() {
        return edit();
    }
