...
public class VerificationPolicy implements Editable<VerificationPolicyBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("spec")
    private VerificationPolicySpec spec;
    @JsonIgnore
    ...
    public VerificationPolicy(String apiVersion, String kind, ObjectMeta metadata, VerificationPolicySpec spec) {
        super();
     ...
     */
    @JsonProperty("spec")
    public VerificationPolicySpec getSpec() {
        return spec;
    }
     ...
     */
    @JsonProperty("spec")
    public void setSpec(VerificationPolicySpec spec) {
        this.spec = spec;
    }

    @JsonIgnore
    public VerificationPolicyBuilder edit() {
        return new VerificationPolicyBuilder(this);
    }

    @JsonIgnore
    public VerificationPolicyBuilder toBuilder() {
        return edit();
    }
