...
public class EgressService implements Editable<EgressServiceBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("spec")
    private EgressServiceSpec spec;
    @JsonProperty("status")
    private EgressServiceStatus status;
    @JsonIgnore
    ...
    public EgressService(String apiVersion, String kind, ObjectMeta metadata, EgressServiceSpec spec, EgressServiceStatus status) {
        super();
    ...
    @JsonIgnore
    public EgressServiceBuilder edit() {
        return new EgressServiceBuilder(this);
    }

    @JsonIgnore
    public EgressServiceBuilder toBuilder() {
        return edit();
    }
