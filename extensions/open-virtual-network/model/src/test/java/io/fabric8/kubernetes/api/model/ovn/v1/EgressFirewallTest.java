...
class EgressFirewallTest {
  ...
  void hasExpectedApiVersion() {
    assertThat(new EgressFirewall().getApiVersion()).isEqualTo("k8s.ovn.org/v1");
  }

  @Test
  void hasExpectedPlural() {
    assertThat(new EgressFirewall().getPlural()).isEqualTo("egressfirewalls");
  }

  @Test
  void hasExpectedKind() {
    assertThat(new EgressFirewall().getKind()).isEqualTo("EgressFirewall");
  }
