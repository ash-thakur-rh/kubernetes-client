...
public class NetworkCorruptSpec implements Editable<NetworkCorruptSpecBuilder>, KubernetesResource
{
    ...
    public NetworkCorruptSpec(String correlation, String device, String egressPort, String hostname, String ipAddress, String ipProtocol, String percent, String sourcePort) {
        super();
    ...
    @JsonIgnore
    public NetworkCorruptSpecBuilder edit() {
        return new NetworkCorruptSpecBuilder(this);
    }

    @JsonIgnore
    public NetworkCorruptSpecBuilder toBuilder() {
        return edit();
    }
