...
public class EmbedChaos implements Editable<EmbedChaosBuilder>, KubernetesResource
{
    ...
    public EmbedChaos(AWSChaosSpec awsChaos, AzureChaosSpec azureChaos, BlockChaosSpec blockChaos, DNSChaosSpec dnsChaos, GCPChaosSpec gcpChaos, HTTPChaosSpec httpChaos, IOChaosSpec ioChaos, JVMChaosSpec jvmChaos, KernelChaosSpec kernelChaos, NetworkChaosSpec networkChaos, PhysicalMachineChaosSpec physicalmachineChaos, PodChaosSpec podChaos, StressChaosSpec stressChaos, TimeChaosSpec timeChaos) {
        super();
