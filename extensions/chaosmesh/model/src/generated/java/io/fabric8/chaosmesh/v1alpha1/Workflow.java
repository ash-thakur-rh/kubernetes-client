...
public class Workflow implements Editable<WorkflowBuilder>, HasMetadata, Namespaced
{
    ...
    public Workflow(String apiVersion, String kind, ObjectMeta metadata, WorkflowSpec spec, WorkflowStatus status) {
        super();
