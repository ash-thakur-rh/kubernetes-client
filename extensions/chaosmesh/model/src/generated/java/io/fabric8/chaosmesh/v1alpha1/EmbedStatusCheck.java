...
public class EmbedStatusCheck implements Editable<EmbedStatusCheckBuilder>, KubernetesResource
{
    ...
    public EmbedStatusCheck(HTTPStatusCheck http) {
        super();
        this.http = http;
    }
    ...
    @JsonIgnore
    public EmbedStatusCheckBuilder edit() {
        return new EmbedStatusCheckBuilder(this);
    }

    @JsonIgnore
    public EmbedStatusCheckBuilder toBuilder() {
        return edit();
    }
