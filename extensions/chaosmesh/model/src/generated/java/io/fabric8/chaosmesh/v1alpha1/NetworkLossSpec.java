...
public class NetworkLossSpec implements Editable<NetworkLossSpecBuilder>, KubernetesResource
{
    ...
    @JsonIgnore
    public NetworkLossSpecBuilder edit() {
        return new NetworkLossSpecBuilder(this);
    }

    @JsonIgnore
    public NetworkLossSpecBuilder toBuilder() {
        return edit();
    }
