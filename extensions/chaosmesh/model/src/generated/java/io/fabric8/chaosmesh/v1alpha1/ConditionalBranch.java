...
public class ConditionalBranch implements Editable<ConditionalBranchBuilder>, KubernetesResource
{
    ...
    public ConditionalBranch(String expression, String target) {
        super();
    ...
    @JsonIgnore
    public ConditionalBranchBuilder edit() {
        return new ConditionalBranchBuilder(this);
    }

    @JsonIgnore
    public ConditionalBranchBuilder toBuilder() {
        return edit();
    }
