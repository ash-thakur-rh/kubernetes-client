...
public class ResourceInfo implements Editable<ResourceInfoBuilder>, KubernetesResource
{
    ...
    public ResourceInfo(String allocatable, Integer capacity) {
        super();
    ...
    @JsonIgnore
    public ResourceInfoBuilder edit() {
        return new ResourceInfoBuilder(this);
    }
