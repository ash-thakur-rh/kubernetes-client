...
public class Queue implements Editable<QueueBuilder>, HasMetadata
{
    ...
    @JsonProperty("kind")
    private String kind = "Queue";
    @JsonProperty("metadata")
    private ObjectMeta metadata;
    @JsonProperty("spec")
    private QueueSpec spec;
    @JsonProperty("status")
    ...
    public Queue(String apiVersion, String kind, ObjectMeta metadata, QueueSpec spec, QueueStatus status) {
        super();
     ...
     */
    @JsonProperty("spec")
    public void setSpec(QueueSpec spec) {
        this.spec = spec;
    }
