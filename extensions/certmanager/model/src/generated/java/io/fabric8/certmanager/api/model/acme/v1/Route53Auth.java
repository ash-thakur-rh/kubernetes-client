...
public class Route53Auth implements Editable<Route53AuthBuilder>, KubernetesResource
{
    ...
    private Route53KubernetesAuth kubernetes;
    @JsonIgnore
    ...
    public Route53Auth(Route53KubernetesAuth kubernetes) {
        super();
    ...
    @JsonIgnore
    public Route53AuthBuilder edit() {
        return new Route53AuthBuilder(this);
    }

    @JsonIgnore
    public Route53AuthBuilder toBuilder() {
        return edit();
    }
