...
public class Route53KubernetesAuth implements Editable<Route53KubernetesAuthBuilder>, KubernetesResource
{
     ...
     */
    public Route53KubernetesAuth() {
    }

    public Route53KubernetesAuth(ServiceAccountRef serviceAccountRef) {
        super();
    ...
    @JsonIgnore
    public Route53KubernetesAuthBuilder edit() {
        return new Route53KubernetesAuthBuilder(this);
    }

    @JsonIgnore
    public Route53KubernetesAuthBuilder toBuilder() {
        return edit();
    }
