...
public class SecretTLS implements Editable<SecretTLSBuilder>, KubernetesResource
{
    ...
    @JsonIgnore
    public SecretTLSBuilder edit() {
        return new SecretTLSBuilder(this);
    }

    @JsonIgnore
    public SecretTLSBuilder toBuilder() {
        return edit();
    }
