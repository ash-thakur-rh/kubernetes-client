...
public class ApiServerSource implements Editable<ApiServerSourceBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("spec")
    private ApiServerSourceSpec spec;
    @JsonProperty("status")
    private ApiServerSourceStatus status;
    @JsonIgnore
     ...
     */
    public ApiServerSource() {
    }

    public ApiServerSource(String apiVersion, String kind, ObjectMeta metadata, ApiServerSourceSpec spec, ApiServerSourceStatus status) {
        super();
    ...
    @JsonIgnore
    public ApiServerSourceBuilder edit() {
        return new ApiServerSourceBuilder(this);
    }

    @JsonIgnore
    public ApiServerSourceBuilder toBuilder() {
        return edit();
    }
