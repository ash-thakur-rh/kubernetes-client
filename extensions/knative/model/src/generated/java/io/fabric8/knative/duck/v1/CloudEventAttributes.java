...
public class CloudEventAttributes implements Editable<CloudEventAttributesBuilder>, KubernetesResource
{
    ...
    public CloudEventAttributes(String source, String type) {
        super();
        this.source = source;
        this.type = type;
    }
    ...
    public CloudEventAttributesBuilder edit() {
        return new CloudEventAttributesBuilder(this);
    }

    @JsonIgnore
    public CloudEventAttributesBuilder toBuilder() {
        return edit();
    }
