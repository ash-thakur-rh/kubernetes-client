...
public class KafkaSource implements Editable<KafkaSourceBuilder>, HasMetadata, Namespaced
{
    ...
    public KafkaSource(String apiVersion, String kind, ObjectMeta metadata, KafkaSourceSpec spec, KafkaSourceStatus status) {
        super();
    ...
    @JsonIgnore
    public KafkaSourceBuilder edit() {
        return new KafkaSourceBuilder(this);
    }

    @JsonIgnore
    public KafkaSourceBuilder toBuilder() {
        return edit();
    }
