...
public class AuthenticatableType implements Editable<AuthenticatableTypeBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("status")
    private AuthenticatableStatus status;
    @JsonIgnore
    ...
    public AuthenticatableType(String apiVersion, String kind, ObjectMeta metadata, AuthenticatableStatus status) {
        super();
    ...
    @JsonIgnore
    public AuthenticatableTypeBuilder edit() {
        return new AuthenticatableTypeBuilder(this);
    }

    @JsonIgnore
    public AuthenticatableTypeBuilder toBuilder() {
        return edit();
    }
