...
public class PodScalableSpec implements Editable<PodScalableSpecBuilder>, KubernetesResource
{
    ...
    @JsonIgnore
    public PodScalableSpecBuilder edit() {
        return new PodScalableSpecBuilder(this);
    }

    @JsonIgnore
    public PodScalableSpecBuilder toBuilder() {
        return edit();
    }
