...
public class PodSpecable implements Editable<PodSpecableBuilder>, KubernetesResource
{
    ...
    public PodSpecable(ObjectMeta metadata, PodSpec spec) {
        super();
    ...
    @JsonIgnore
    public PodSpecableBuilder toBuilder() {
        return edit();
    }
