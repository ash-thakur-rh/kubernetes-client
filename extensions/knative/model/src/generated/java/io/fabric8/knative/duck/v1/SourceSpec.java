...
public class SourceSpec implements Editable<SourceSpecBuilder>, KubernetesResource
{
    ...
    public SourceSpec(CloudEventOverrides ceOverrides, Destination sink) {
        super();
    ...
    @JsonIgnore
    public SourceSpecBuilder edit() {
        return new SourceSpecBuilder(this);
    }

    @JsonIgnore
    public SourceSpecBuilder toBuilder() {
        return edit();
    }
