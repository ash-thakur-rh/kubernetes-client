...
public class Parallel implements Editable<ParallelBuilder>, HasMetadata, Namespaced
{
    ...
    public Parallel(String apiVersion, String kind, ObjectMeta metadata, ParallelSpec spec, ParallelStatus status) {
        super();
     ...
     */
    @JsonProperty("status")
    public ParallelStatus getStatus() {
        return status;
    }
     ...
     */
    @JsonProperty("status")
    public void setStatus(ParallelStatus status) {
        this.status = status;
    }

    @JsonIgnore
    public ParallelBuilder edit() {
        return new ParallelBuilder(this);
    }

    @JsonIgnore
    public ParallelBuilder toBuilder() {
        return edit();
    }
