...
public class DomainMapping implements Editable<DomainMappingBuilder>, HasMetadata, Namespaced
{
    ...
    public DomainMapping(String apiVersion, String kind, ObjectMeta metadata, DomainMappingSpec spec, DomainMappingStatus status) {
        super();
    ...
    @JsonIgnore
    public DomainMappingBuilder edit() {
        return new DomainMappingBuilder(this);
    }

    @JsonIgnore
    public DomainMappingBuilder toBuilder() {
        return edit();
    }
