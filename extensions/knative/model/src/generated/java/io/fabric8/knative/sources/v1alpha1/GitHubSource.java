...
public class GitHubSource implements Editable<GitHubSourceBuilder>, HasMetadata, Namespaced
{
    ...
    public GitHubSource(String apiVersion, String kind, ObjectMeta metadata, GitHubSourceSpec spec, GitHubSourceStatus status) {
        super();
    ...
    @JsonIgnore
    public GitHubSourceBuilder edit() {
        return new GitHubSourceBuilder(this);
    }

    @JsonIgnore
    public GitHubSourceBuilder toBuilder() {
        return edit();
    }
