...
public class Source implements Editable<SourceBuilder>, HasMetadata, Namespaced
{
    ...
    public Source(String apiVersion, String kind, ObjectMeta metadata, SourceSpec spec, SourceStatus status) {
        super();
