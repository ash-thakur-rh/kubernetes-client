...
public class AddressableType implements Editable<AddressableTypeBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("kind")
    private String kind = "AddressableType";
     ...
     */
    public AddressableType() {
    }

    public AddressableType(String apiVersion, String kind, ObjectMeta metadata, AddressStatus status) {
        super();
    ...
    @JsonIgnore
    public AddressableTypeBuilder edit() {
        return new AddressableTypeBuilder(this);
    }

    @JsonIgnore
    public AddressableTypeBuilder toBuilder() {
        return edit();
    }
