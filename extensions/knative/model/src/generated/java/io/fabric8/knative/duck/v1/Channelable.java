...
public class Channelable implements Editable<ChannelableBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("spec")
    private ChannelableSpec spec;
    @JsonProperty("status")
    private ChannelableStatus status;
    @JsonIgnore
    ...
    public Channelable(String apiVersion, String kind, ObjectMeta metadata, ChannelableSpec spec, ChannelableStatus status) {
        super();
    ...
    @JsonIgnore
    public ChannelableBuilder edit() {
        return new ChannelableBuilder(this);
    }

    @JsonIgnore
    public ChannelableBuilder toBuilder() {
        return edit();
    }
