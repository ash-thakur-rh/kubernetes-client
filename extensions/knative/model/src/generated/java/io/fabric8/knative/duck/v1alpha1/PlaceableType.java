...
public class PlaceableType implements Editable<PlaceableTypeBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("status")
    private PlaceableStatus status;
    @JsonIgnore
    ...
    public PlaceableType(String apiVersion, String kind, ObjectMeta metadata, PlaceableStatus status) {
        super();
     ...
     */
    @JsonProperty("status")
    public PlaceableStatus getStatus() {
        return status;
    }
     ...
     */
    @JsonProperty("status")
    public void setStatus(PlaceableStatus status) {
        this.status = status;
    }

    @JsonIgnore
    public PlaceableTypeBuilder edit() {
        return new PlaceableTypeBuilder(this);
    }

    @JsonIgnore
    public PlaceableTypeBuilder toBuilder() {
        return edit();
    }
