...
public class KResource implements Editable<KResourceBuilder>, HasMetadata, Namespaced
{
    ...
    public KResource(String apiVersion, String kind, ObjectMeta metadata, Status status) {
        super();
    ...
    @JsonIgnore
    public KResourceBuilder edit() {
        return new KResourceBuilder(this);
    }

    @JsonIgnore
    public KResourceBuilder toBuilder() {
        return edit();
    }
