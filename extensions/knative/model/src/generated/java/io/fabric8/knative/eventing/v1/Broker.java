...
public class Broker implements Editable<BrokerBuilder>, HasMetadata, Namespaced
{
    ...
    public Broker(String apiVersion, String kind, ObjectMeta metadata, BrokerSpec spec, BrokerStatus status) {
        super();
     ...
     */
    @JsonProperty("spec")
    public void setSpec(BrokerSpec spec) {
        this.spec = spec;
    }
    ...
    @JsonIgnore
    public BrokerBuilder edit() {
        return new BrokerBuilder(this);
    }

    @JsonIgnore
    public BrokerBuilder toBuilder() {
        return edit();
    }
