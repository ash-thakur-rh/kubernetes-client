...
public class PodScalableStatus implements Editable<PodScalableStatusBuilder>, KubernetesResource
{
    ...
    public PodScalableStatus(Integer replicas) {
        super();
    ...
    @JsonIgnore
    public PodScalableStatusBuilder edit() {
        return new PodScalableStatusBuilder(this);
    }

    @JsonIgnore
    public PodScalableStatusBuilder toBuilder() {
        return edit();
    }
