...
public class VolumeSnapshot implements Editable<VolumeSnapshotBuilder>, HasMetadata, Namespaced
{

    @JsonProperty("apiVersion")
    private String apiVersion = "snapshot.storage.k8s.io/v1";
    @JsonProperty("kind")
    private String kind = "VolumeSnapshot";
    ...
    public VolumeSnapshot(String apiVersion, String kind, ObjectMeta metadata, VolumeSnapshotSpec spec, VolumeSnapshotStatus status) {
        super();
    ...
    @JsonIgnore
    public VolumeSnapshotBuilder edit() {
        return new VolumeSnapshotBuilder(this);
    }
