...
public class TracingTracingSelector implements Editable<TracingTracingSelectorBuilder>, KubernetesResource
{
    ...
    public TracingTracingSelector(WorkloadMode mode) {
        super();
        this.mode = mode;
    }
    ...
    @JsonIgnore
    public TracingTracingSelectorBuilder edit() {
        return new TracingTracingSelectorBuilder(this);
    }

    @JsonIgnore
    public TracingTracingSelectorBuilder toBuilder() {
        return edit();
    }
