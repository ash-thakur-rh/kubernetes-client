...
public class ServiceEntry implements Editable<ServiceEntryBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("spec")
    private io.fabric8.istio.api.api.networking.v1alpha3.ServiceEntry spec;
    @JsonProperty("status")
    ...
    public ServiceEntry(String apiVersion, String kind, ObjectMeta metadata, io.fabric8.istio.api.api.networking.v1alpha3.ServiceEntry spec, ServiceEntryStatus status) {
        super();
