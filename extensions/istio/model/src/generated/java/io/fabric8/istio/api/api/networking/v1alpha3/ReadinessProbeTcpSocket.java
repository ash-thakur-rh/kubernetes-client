...
public class ReadinessProbeTcpSocket implements IsReadinessProbeHealthCheckMethod, Editable<ReadinessProbeTcpSocketBuilder>, KubernetesResource
{
    ...
    private TCPHealthCheckConfig tcpSocket;
    @JsonIgnore
    ...
    public ReadinessProbeTcpSocket(TCPHealthCheckConfig tcpSocket) {
        super();
    ...
    @JsonIgnore
    public ReadinessProbeTcpSocketBuilder edit() {
        return new ReadinessProbeTcpSocketBuilder(this);
    }

    @JsonIgnore
    public ReadinessProbeTcpSocketBuilder toBuilder() {
        return edit();
    }
