...
public class AuthorizationPolicy implements Editable<AuthorizationPolicyBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("kind")
    private String kind = "AuthorizationPolicy";
    @JsonProperty("metadata")
    private ObjectMeta metadata;
    @JsonProperty("spec")
    private io.fabric8.istio.api.api.security.v1beta1.AuthorizationPolicy spec;
    @JsonProperty("status")
    ...
    public AuthorizationPolicy(String apiVersion, String kind, ObjectMeta metadata, io.fabric8.istio.api.api.security.v1beta1.AuthorizationPolicy spec, IstioStatus status) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.fabric8.istio.api.api.security.v1beta1.AuthorizationPolicy getSpec() {
        return spec;
    }
     ...
     */
    @JsonProperty("spec")
    public void setSpec(io.fabric8.istio.api.api.security.v1beta1.AuthorizationPolicy spec) {
        this.spec = spec;
    }
