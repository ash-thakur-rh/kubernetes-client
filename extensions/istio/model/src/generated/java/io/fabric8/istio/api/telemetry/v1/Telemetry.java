...
public class Telemetry implements Editable<TelemetryBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("spec")
    private io.fabric8.istio.api.api.telemetry.v1alpha1.Telemetry spec;
    @JsonProperty("status")
    ...
    public Telemetry(String apiVersion, String kind, ObjectMeta metadata, io.fabric8.istio.api.api.telemetry.v1alpha1.Telemetry spec, IstioStatus status) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.fabric8.istio.api.api.telemetry.v1alpha1.Telemetry getSpec() {
        return spec;
    }
     ...
     */
    @JsonProperty("spec")
    public void setSpec(io.fabric8.istio.api.api.telemetry.v1alpha1.Telemetry spec) {
        this.spec = spec;
    }
