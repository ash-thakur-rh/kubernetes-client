...
public class WorkloadGroup implements Editable<WorkloadGroupBuilder>, HasMetadata, Namespaced
{

    @JsonProperty("apiVersion")
    private String apiVersion = "networking.istio.io/v1";
    @JsonProperty("kind")
    private String kind = "WorkloadGroup";
    @JsonProperty("metadata")
    private ObjectMeta metadata;
    @JsonProperty("spec")
    private io.fabric8.istio.api.api.networking.v1alpha3.WorkloadGroup spec;
    @JsonProperty("status")
    ...
    public WorkloadGroup(String apiVersion, String kind, ObjectMeta metadata, io.fabric8.istio.api.api.networking.v1alpha3.WorkloadGroup spec, IstioStatus status) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.fabric8.istio.api.api.networking.v1alpha3.WorkloadGroup getSpec() {
        return spec;
    }
     ...
     */
    @JsonProperty("spec")
    public void setSpec(io.fabric8.istio.api.api.networking.v1alpha3.WorkloadGroup spec) {
        this.spec = spec;
    }
    ...
    @JsonIgnore
    public WorkloadGroupBuilder edit() {
        return new WorkloadGroupBuilder(this);
    }

    @JsonIgnore
    public WorkloadGroupBuilder toBuilder() {
        return edit();
    }
