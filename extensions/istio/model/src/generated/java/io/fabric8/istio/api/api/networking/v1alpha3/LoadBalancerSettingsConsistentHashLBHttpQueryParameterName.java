...
public class LoadBalancerSettingsConsistentHashLBHttpQueryParameterName implements IsLoadBalancerSettingsConsistentHashLBHashKey, Editable<LoadBalancerSettingsConsistentHashLBHttpQueryParameterNameBuilder>, KubernetesResource
{
    ...
    public LoadBalancerSettingsConsistentHashLBHttpQueryParameterName(String httpQueryParameterName) {
        super();
    ...
    @JsonIgnore
    public LoadBalancerSettingsConsistentHashLBHttpQueryParameterNameBuilder edit() {
        return new LoadBalancerSettingsConsistentHashLBHttpQueryParameterNameBuilder(this);
    }

    @JsonIgnore
    public LoadBalancerSettingsConsistentHashLBHttpQueryParameterNameBuilder toBuilder() {
        return edit();
    }
