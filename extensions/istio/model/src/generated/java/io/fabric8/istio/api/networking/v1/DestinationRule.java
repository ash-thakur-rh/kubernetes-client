...
public class DestinationRule implements Editable<DestinationRuleBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("spec")
    private io.fabric8.istio.api.api.networking.v1alpha3.DestinationRule spec;
    @JsonProperty("status")
    ...
    public DestinationRule(String apiVersion, String kind, ObjectMeta metadata, io.fabric8.istio.api.api.networking.v1alpha3.DestinationRule spec, IstioStatus status) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.fabric8.istio.api.api.networking.v1alpha3.DestinationRule getSpec() {
        return spec;
    }
     ...
     */
    @JsonProperty("spec")
    public void setSpec(io.fabric8.istio.api.api.networking.v1alpha3.DestinationRule spec) {
        this.spec = spec;
    }
