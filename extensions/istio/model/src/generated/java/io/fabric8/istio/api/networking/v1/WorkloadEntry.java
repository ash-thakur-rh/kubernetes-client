...
public class WorkloadEntry implements Editable<WorkloadEntryBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("kind")
    private String kind = "WorkloadEntry";
    @JsonProperty("metadata")
    private ObjectMeta metadata;
    @JsonProperty("spec")
    private io.fabric8.istio.api.api.networking.v1alpha3.WorkloadEntry spec;
    @JsonProperty("status")
    ...
    public WorkloadEntry(String apiVersion, String kind, ObjectMeta metadata, io.fabric8.istio.api.api.networking.v1alpha3.WorkloadEntry spec, IstioStatus status) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.fabric8.istio.api.api.networking.v1alpha3.WorkloadEntry getSpec() {
        return spec;
    }
     ...
     */
    @JsonProperty("spec")
    public void setSpec(io.fabric8.istio.api.api.networking.v1alpha3.WorkloadEntry spec) {
        this.spec = spec;
    }
