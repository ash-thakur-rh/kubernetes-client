...
public class ProviderRef implements Editable<ProviderRefBuilder>, KubernetesResource
{
    ...
    public ProviderRef(String name) {
        super();
        this.name = name;
    }
    ...
    @JsonIgnore
    public ProviderRefBuilder edit() {
        return new ProviderRefBuilder(this);
    }

    @JsonIgnore
    public ProviderRefBuilder toBuilder() {
        return edit();
    }
