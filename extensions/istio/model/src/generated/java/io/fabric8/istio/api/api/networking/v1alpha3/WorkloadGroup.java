...
public class WorkloadGroup implements Editable<WorkloadGroupBuilder>, KubernetesResource, Namespaced
{
    ...
    private WorkloadEntry template;
    @JsonIgnore
    ...
    public WorkloadGroup(WorkloadGroupObjectMeta metadata, ReadinessProbe probe, WorkloadEntry template) {
        super();
