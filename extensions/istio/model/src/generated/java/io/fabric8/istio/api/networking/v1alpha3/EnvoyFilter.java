...
public class EnvoyFilter implements Editable<EnvoyFilterBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("spec")
    private io.fabric8.istio.api.api.networking.v1alpha3.EnvoyFilter spec;
    @JsonProperty("status")
    ...
    public EnvoyFilter(String apiVersion, String kind, ObjectMeta metadata, io.fabric8.istio.api.api.networking.v1alpha3.EnvoyFilter spec, IstioStatus status) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.fabric8.istio.api.api.networking.v1alpha3.EnvoyFilter getSpec() {
        return spec;
    }
     ...
     */
    @JsonProperty("spec")
    public void setSpec(io.fabric8.istio.api.api.networking.v1alpha3.EnvoyFilter spec) {
        this.spec = spec;
    }
