...
public class IstioCondition implements Editable<IstioConditionBuilder>, KubernetesResource
{
    ...
    @JsonIgnore
    public IstioConditionBuilder edit() {
        return new IstioConditionBuilder(this);
    }

    @JsonIgnore
    public IstioConditionBuilder toBuilder() {
        return edit();
    }
