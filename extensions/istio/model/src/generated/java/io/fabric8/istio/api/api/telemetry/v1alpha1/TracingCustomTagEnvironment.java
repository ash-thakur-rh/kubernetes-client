...
public class TracingCustomTagEnvironment implements IsTracingCustomTagType, Editable<TracingCustomTagEnvironmentBuilder>, KubernetesResource
{
    ...
    private TracingEnvironment environment;
    @JsonIgnore
    ...
    public TracingCustomTagEnvironment(TracingEnvironment environment) {
        super();
    ...
    @JsonIgnore
    public TracingCustomTagEnvironmentBuilder edit() {
        return new TracingCustomTagEnvironmentBuilder(this);
    }

    @JsonIgnore
    public TracingCustomTagEnvironmentBuilder toBuilder() {
        return edit();
    }
