...
public class TracingCustomTag implements Editable<TracingCustomTagBuilder>, KubernetesResource
{

    @JsonProperty("Type")
    @JsonUnwrapped
    private IsTracingCustomTagType type;
    @JsonIgnore
    ...
    public TracingCustomTag(IsTracingCustomTagType type) {
        super();
        this.type = type;
    }
    ...
    @JsonIgnore
    public TracingCustomTagBuilder edit() {
        return new TracingCustomTagBuilder(this);
    }

    @JsonIgnore
    public TracingCustomTagBuilder toBuilder() {
        return edit();
    }
