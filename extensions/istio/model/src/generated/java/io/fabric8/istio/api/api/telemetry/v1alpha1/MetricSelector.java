...
public class MetricSelector implements Editable<MetricSelectorBuilder>, KubernetesResource
{

    @JsonProperty("MetricMatch")
    @JsonUnwrapped
    private IsMetricSelectorMetricMatch metricMatch;
    @JsonProperty("mode")
    ...
    public MetricSelector(IsMetricSelectorMetricMatch metricMatch, WorkloadMode mode) {
        super();
    ...
    @JsonIgnore
    public MetricSelectorBuilder edit() {
        return new MetricSelectorBuilder(this);
    }

    @JsonIgnore
    public MetricSelectorBuilder toBuilder() {
        return edit();
    }
