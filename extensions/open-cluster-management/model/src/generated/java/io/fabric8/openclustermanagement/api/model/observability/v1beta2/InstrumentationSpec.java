...
public class InstrumentationSpec implements Editable<InstrumentationSpecBuilder>, KubernetesResource
{
    ...
    public InstrumentationSpec(Boolean enabled) {
        super();
    ...
    @JsonIgnore
    public InstrumentationSpecBuilder edit() {
        return new InstrumentationSpecBuilder(this);
    }

    @JsonIgnore
    public InstrumentationSpecBuilder toBuilder() {
        return edit();
    }
