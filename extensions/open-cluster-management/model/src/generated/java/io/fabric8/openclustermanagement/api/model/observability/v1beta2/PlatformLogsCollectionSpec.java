...
public class PlatformLogsCollectionSpec implements Editable<PlatformLogsCollectionSpecBuilder>, KubernetesResource
{
     ...
     */
    public PlatformLogsCollectionSpec() {
    }

    public PlatformLogsCollectionSpec(Boolean enabled) {
        super();
    ...
    @JsonIgnore
    public PlatformLogsCollectionSpecBuilder edit() {
        return new PlatformLogsCollectionSpecBuilder(this);
    }

    @JsonIgnore
    public PlatformLogsCollectionSpecBuilder toBuilder() {
        return edit();
    }
