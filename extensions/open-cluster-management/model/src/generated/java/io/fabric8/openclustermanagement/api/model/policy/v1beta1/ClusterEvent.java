...
public class ClusterEvent implements Editable<ClusterEventBuilder>, KubernetesResource
{
    ...
    public ClusterEvent(String automationStartTime, String eventTime) {
        super();
    ...
    @JsonIgnore
    public ClusterEventBuilder edit() {
        return new ClusterEventBuilder(this);
    }

    @JsonIgnore
    public ClusterEventBuilder toBuilder() {
        return edit();
    }
