...
public class PlacementSubject implements Editable<PlacementSubjectBuilder>, KubernetesResource
{
    ...
    @JsonIgnore
    public PlacementSubjectBuilder edit() {
        return new PlacementSubjectBuilder(this);
    }

    @JsonIgnore
    public PlacementSubjectBuilder toBuilder() {
        return edit();
    }
