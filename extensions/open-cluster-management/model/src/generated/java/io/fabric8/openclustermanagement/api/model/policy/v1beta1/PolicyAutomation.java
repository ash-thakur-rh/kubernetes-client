...
public class PolicyAutomation implements Editable<PolicyAutomationBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("spec")
    private PolicyAutomationSpec spec;
    @JsonProperty("status")
    private PolicyAutomationStatus status;
    @JsonIgnore
    ...
    public PolicyAutomation(String apiVersion, String kind, ObjectMeta metadata, PolicyAutomationSpec spec, PolicyAutomationStatus status) {
        super();
    ...
    @JsonIgnore
    public PolicyAutomationBuilder edit() {
        return new PolicyAutomationBuilder(this);
    }

    @JsonIgnore
    public PolicyAutomationBuilder toBuilder() {
        return edit();
    }
