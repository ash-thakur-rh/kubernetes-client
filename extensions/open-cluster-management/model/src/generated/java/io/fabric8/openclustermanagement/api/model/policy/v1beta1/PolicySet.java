...
public class PolicySet implements Editable<PolicySetBuilder>, HasMetadata, Namespaced
{
    ...
    public PolicySet(String apiVersion, String kind, ObjectMeta metadata, PolicySetSpec spec, PolicySetStatus status) {
        super();
    ...
    @JsonIgnore
    public PolicySetBuilder edit() {
        return new PolicySetBuilder(this);
    }

    @JsonIgnore
    public PolicySetBuilder toBuilder() {
        return edit();
    }
