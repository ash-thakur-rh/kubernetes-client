...
public class Search implements Editable<SearchBuilder>, HasMetadata, Namespaced
{
    ...
    public Search(String apiVersion, String kind, ObjectMeta metadata, SearchSpec spec, SearchStatus status) {
        super();
     ...
     */
    @JsonProperty("spec")
    public void setSpec(SearchSpec spec) {
        this.spec = spec;
    }
    ...
    @JsonIgnore
    public SearchBuilder edit() {
        return new SearchBuilder(this);
    }

    @JsonIgnore
    public SearchBuilder toBuilder() {
        return edit();
    }
