...
public class Policy implements Editable<PolicyBuilder>, HasMetadata, Namespaced
{
    ...
    public Policy(String apiVersion, String kind, ObjectMeta metadata, PolicySpec spec, PolicyStatus status) {
        super();
     ...
     */
    @JsonProperty("spec")
    public void setSpec(PolicySpec spec) {
        this.spec = spec;
    }
