...
public class KlusterletDeployOption implements Editable<KlusterletDeployOptionBuilder>, KubernetesResource
{
    ...
    public KlusterletDeployOption(String mode) {
        super();
        this.mode = mode;
    }
    ...
    @JsonIgnore
    public KlusterletDeployOptionBuilder edit() {
        return new KlusterletDeployOptionBuilder(this);
    }

    @JsonIgnore
    public KlusterletDeployOptionBuilder toBuilder() {
        return edit();
    }
