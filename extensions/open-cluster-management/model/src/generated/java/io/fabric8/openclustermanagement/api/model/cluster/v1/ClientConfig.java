...
public class ClientConfig implements Editable<ClientConfigBuilder>, KubernetesResource
{
    ...
    public ClientConfig(String caBundle, String url) {
        super();
    ...
    @JsonIgnore
    public ClientConfigBuilder edit() {
        return new ClientConfigBuilder(this);
    }
