...
public class ObservabilityAddon implements Editable<ObservabilityAddonBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("spec")
    private ObservabilityAddonSpec spec;
    @JsonProperty("status")
    private ObservabilityAddonStatus status;
    @JsonIgnore
    ...
    public ObservabilityAddon(String apiVersion, String kind, ObjectMeta metadata, ObservabilityAddonSpec spec, ObservabilityAddonStatus status) {
        super();
    ...
    @JsonIgnore
    public ObservabilityAddonBuilder edit() {
        return new ObservabilityAddonBuilder(this);
    }

    @JsonIgnore
    public ObservabilityAddonBuilder toBuilder() {
        return edit();
    }
