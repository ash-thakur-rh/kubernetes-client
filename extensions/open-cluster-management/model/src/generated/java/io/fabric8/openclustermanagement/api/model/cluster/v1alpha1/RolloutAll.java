...
public class RolloutAll implements Editable<RolloutAllBuilder>, KubernetesResource
{
    ...
    public RolloutAll(IntOrString maxFailures, Duration minSuccessTime, String progressDeadline) {
        super();
    ...
    @JsonIgnore
    public RolloutAllBuilder edit() {
        return new RolloutAllBuilder(this);
    }

    @JsonIgnore
    public RolloutAllBuilder toBuilder() {
        return edit();
    }
