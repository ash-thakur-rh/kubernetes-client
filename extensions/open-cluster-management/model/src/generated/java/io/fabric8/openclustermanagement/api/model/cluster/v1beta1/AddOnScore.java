...
public class AddOnScore implements Editable<AddOnScoreBuilder>, KubernetesResource
{
    ...
    public AddOnScore(String resourceName, String scoreName) {
        super();
    ...
    @JsonIgnore
    public AddOnScoreBuilder edit() {
        return new AddOnScoreBuilder(this);
    }

    @JsonIgnore
    public AddOnScoreBuilder toBuilder() {
        return edit();
    }
