...
public class ManagedClusterSetBinding implements Editable<ManagedClusterSetBindingBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("spec")
    private ManagedClusterSetBindingSpec spec;
    @JsonProperty("status")
    private ManagedClusterSetBindingStatus status;
    @JsonIgnore
     ...
     */
    public ManagedClusterSetBinding() {
    }

    public ManagedClusterSetBinding(String apiVersion, String kind, ObjectMeta metadata, ManagedClusterSetBindingSpec spec, ManagedClusterSetBindingStatus status) {
        super();
    ...
    @JsonIgnore
    public ManagedClusterSetBindingBuilder edit() {
        return new ManagedClusterSetBindingBuilder(this);
    }

    @JsonIgnore
    public ManagedClusterSetBindingBuilder toBuilder() {
        return edit();
    }
