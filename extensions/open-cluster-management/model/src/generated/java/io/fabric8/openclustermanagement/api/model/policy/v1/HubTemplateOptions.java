...
public class HubTemplateOptions implements Editable<HubTemplateOptionsBuilder>, KubernetesResource
{
    ...
    public HubTemplateOptions(String serviceAccountName) {
        super();
    ...
    @JsonIgnore
    public HubTemplateOptionsBuilder edit() {
        return new HubTemplateOptionsBuilder(this);
    }

    @JsonIgnore
    public HubTemplateOptionsBuilder toBuilder() {
        return edit();
    }
