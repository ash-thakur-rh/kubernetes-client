...
public class Channel implements Editable<ChannelBuilder>, HasMetadata, Namespaced
{
    ...
    public Channel(String apiVersion, String kind, ObjectMeta metadata, ChannelSpec spec, ChannelStatus status) {
        super();
