...
public class AddOnPlacementScore implements Editable<AddOnPlacementScoreBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("status")
    private AddOnPlacementScoreStatus status;
    @JsonIgnore
     ...
     */
    public AddOnPlacementScore() {
    }

    public AddOnPlacementScore(String apiVersion, String kind, ObjectMeta metadata, AddOnPlacementScoreStatus status) {
        super();
    ...
    @JsonIgnore
    public AddOnPlacementScoreBuilder edit() {
        return new AddOnPlacementScoreBuilder(this);
    }

    @JsonIgnore
    public AddOnPlacementScoreBuilder toBuilder() {
        return edit();
    }
