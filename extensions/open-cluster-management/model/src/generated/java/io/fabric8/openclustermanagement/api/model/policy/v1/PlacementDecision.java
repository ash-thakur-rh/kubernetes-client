...
public class PlacementDecision implements Editable<PlacementDecisionBuilder>, KubernetesResource
{
    ...
    public PlacementDecision(String clusterName, String clusterNamespace) {
        super();
