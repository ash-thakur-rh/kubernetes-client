...
public class RelatedResourceMeta implements Editable<RelatedResourceMetaBuilder>, KubernetesResource
{
    ...
    public RelatedResourceMeta(String group, String name, String namespace, String resource, String version) {
        super();
        this.group = group;
        this.name = name;
    ...
    @JsonIgnore
    public RelatedResourceMetaBuilder edit() {
        return new RelatedResourceMetaBuilder(this);
    }

    @JsonIgnore
    public RelatedResourceMetaBuilder toBuilder() {
        return edit();
    }
