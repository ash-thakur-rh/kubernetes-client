...
public class UserWorkloadTracesSpec implements Editable<UserWorkloadTracesSpecBuilder>, KubernetesResource
{
    ...
    private OpenTelemetryCollectionSpec collection;
    @JsonIgnore
    ...
    public UserWorkloadTracesSpec(OpenTelemetryCollectionSpec collection) {
        super();
    ...
    @JsonIgnore
    public UserWorkloadTracesSpecBuilder edit() {
        return new UserWorkloadTracesSpecBuilder(this);
    }

    @JsonIgnore
    public UserWorkloadTracesSpecBuilder toBuilder() {
        return edit();
    }
