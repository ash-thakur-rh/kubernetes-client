...
public class PolicyAutomationStatus implements Editable<PolicyAutomationStatusBuilder>, KubernetesResource
{

    @JsonProperty("clustersWithEvent")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    private Map<String, ClusterEvent> clustersWithEvent = new LinkedHashMap<>();
    @JsonIgnore
    ...
    public PolicyAutomationStatus(Map<String, ClusterEvent> clustersWithEvent) {
        super();
    ...
    public PolicyAutomationStatusBuilder edit() {
        return new PolicyAutomationStatusBuilder(this);
    }

    @JsonIgnore
    public PolicyAutomationStatusBuilder toBuilder() {
        return edit();
    }
