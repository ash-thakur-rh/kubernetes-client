...
public class IngressControllerLogging implements Editable<IngressControllerLoggingBuilder>, KubernetesResource
{
    ...
    public IngressControllerLogging(AccessLogging access) {
        super();
        this.access = access;
    }
    ...
    @JsonIgnore
    public IngressControllerLoggingBuilder edit() {
        return new IngressControllerLoggingBuilder(this);
    }

    @JsonIgnore
    public IngressControllerLoggingBuilder toBuilder() {
        return edit();
    }
