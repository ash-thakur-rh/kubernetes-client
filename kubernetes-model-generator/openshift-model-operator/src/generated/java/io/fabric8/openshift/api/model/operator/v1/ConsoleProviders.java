...
public class ConsoleProviders implements Editable<ConsoleProvidersBuilder>, KubernetesResource
{
    ...
    private StatuspageProvider statuspage;
    @JsonIgnore
    ...
    public ConsoleProviders(StatuspageProvider statuspage) {
        super();
    ...
    @JsonIgnore
    public ConsoleProvidersBuilder edit() {
        return new ConsoleProvidersBuilder(this);
    }

    @JsonIgnore
    public ConsoleProvidersBuilder toBuilder() {
        return edit();
    }
