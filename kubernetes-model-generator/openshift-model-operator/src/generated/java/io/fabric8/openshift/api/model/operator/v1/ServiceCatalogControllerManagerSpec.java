...
public class ServiceCatalogControllerManagerSpec implements Editable<ServiceCatalogControllerManagerSpecBuilder>, KubernetesResource
{
    ...
    public ServiceCatalogControllerManagerSpec(String logLevel, String managementState, Object observedConfig, String operatorLogLevel, Object unsupportedConfigOverrides) {
        super();
    ...
    @JsonIgnore
    public ServiceCatalogControllerManagerSpecBuilder edit() {
        return new ServiceCatalogControllerManagerSpecBuilder(this);
    }

    @JsonIgnore
    public ServiceCatalogControllerManagerSpecBuilder toBuilder() {
        return edit();
    }
