...
public class Capability implements Editable<CapabilityBuilder>, KubernetesResource
{
    ...
    public Capability(String name, CapabilityVisibility visibility) {
        super();
        this.name = name;
    ...
    @JsonIgnore
    public CapabilityBuilder edit() {
        return new CapabilityBuilder(this);
    }

    @JsonIgnore
    public CapabilityBuilder toBuilder() {
        return edit();
    }
