...
public class ServiceCASpec implements Editable<ServiceCASpecBuilder>, KubernetesResource
{
    ...
    public ServiceCASpec(String logLevel, String managementState, Object observedConfig, String operatorLogLevel, Object unsupportedConfigOverrides) {
        super();
    ...
    @JsonIgnore
    public ServiceCASpecBuilder edit() {
        return new ServiceCASpecBuilder(this);
    }

    @JsonIgnore
    public ServiceCASpecBuilder toBuilder() {
        return edit();
    }
