...
public class IPv6GatewayConfig implements Editable<IPv6GatewayConfigBuilder>, KubernetesResource
{
    ...
    @JsonIgnore
    public IPv6GatewayConfigBuilder edit() {
        return new IPv6GatewayConfigBuilder(this);
    }

    @JsonIgnore
    public IPv6GatewayConfigBuilder toBuilder() {
        return edit();
    }
