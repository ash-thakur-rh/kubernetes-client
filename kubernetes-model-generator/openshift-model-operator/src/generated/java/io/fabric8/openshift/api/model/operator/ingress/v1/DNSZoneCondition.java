...
public class DNSZoneCondition implements Editable<DNSZoneConditionBuilder>, KubernetesResource
{
    ...
    public DNSZoneCondition(String lastTransitionTime, String message, String reason, String status, String type) {
        super();
    ...
    @JsonIgnore
    public DNSZoneConditionBuilder edit() {
        return new DNSZoneConditionBuilder(this);
    }

    @JsonIgnore
    public DNSZoneConditionBuilder toBuilder() {
        return edit();
    }
