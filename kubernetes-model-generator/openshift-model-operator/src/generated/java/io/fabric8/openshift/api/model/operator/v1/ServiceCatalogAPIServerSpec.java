...
public class ServiceCatalogAPIServerSpec implements Editable<ServiceCatalogAPIServerSpecBuilder>, KubernetesResource
{
    ...
    public ServiceCatalogAPIServerSpec(String logLevel, String managementState, Object observedConfig, String operatorLogLevel, Object unsupportedConfigOverrides) {
        super();
    ...
    @JsonIgnore
    public ServiceCatalogAPIServerSpecBuilder edit() {
        return new ServiceCatalogAPIServerSpecBuilder(this);
    }

    @JsonIgnore
    public ServiceCatalogAPIServerSpecBuilder toBuilder() {
        return edit();
    }
