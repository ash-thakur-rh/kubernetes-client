...
public class ClusterVersionOperatorSpec implements Editable<ClusterVersionOperatorSpecBuilder>, KubernetesResource
{
     ...
     */
    public ClusterVersionOperatorSpec() {
    }

    public ClusterVersionOperatorSpec(String operatorLogLevel) {
        super();
    ...
    @JsonIgnore
    public ClusterVersionOperatorSpecBuilder edit() {
        return new ClusterVersionOperatorSpecBuilder(this);
    }

    @JsonIgnore
    public ClusterVersionOperatorSpecBuilder toBuilder() {
        return edit();
    }
