...
public class OLMSpec implements Editable<OLMSpecBuilder>, KubernetesResource
{
    ...
    public OLMSpec(String logLevel, String managementState, Object observedConfig, String operatorLogLevel, Object unsupportedConfigOverrides) {
        super();
    ...
    @JsonIgnore
    public OLMSpecBuilder edit() {
        return new OLMSpecBuilder(this);
    }

    @JsonIgnore
    public OLMSpecBuilder toBuilder() {
        return edit();
    }
