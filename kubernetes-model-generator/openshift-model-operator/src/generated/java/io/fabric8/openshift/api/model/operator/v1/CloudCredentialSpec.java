...
public class CloudCredentialSpec implements Editable<CloudCredentialSpecBuilder>, KubernetesResource
{
    ...
    public CloudCredentialSpec(String credentialsMode, String logLevel, String managementState, Object observedConfig, String operatorLogLevel, Object unsupportedConfigOverrides) {
        super();
    ...
    public CloudCredentialSpecBuilder edit() {
        return new CloudCredentialSpecBuilder(this);
    }
