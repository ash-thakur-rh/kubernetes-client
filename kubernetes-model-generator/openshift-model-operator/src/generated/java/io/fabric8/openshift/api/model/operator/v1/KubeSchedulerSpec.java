...
public class KubeSchedulerSpec implements Editable<KubeSchedulerSpecBuilder>, KubernetesResource
{
    ...
    public KubeSchedulerSpec(Integer failedRevisionLimit, String forceRedeploymentReason, String logLevel, String managementState, Object observedConfig, String operatorLogLevel, Integer succeededRevisionLimit, Object unsupportedConfigOverrides) {
        super();
    ...
    @JsonIgnore
    public KubeSchedulerSpecBuilder edit() {
        return new KubeSchedulerSpecBuilder(this);
    }

    @JsonIgnore
    public KubeSchedulerSpecBuilder toBuilder() {
        return edit();
    }
