...
public class Theme implements Editable<ThemeBuilder>, KubernetesResource
{

    @JsonProperty("mode")
    private String mode;
    @JsonProperty("source")
    private FileReferenceSource source;
    @JsonIgnore
