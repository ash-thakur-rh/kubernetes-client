...
public class StaticIPAMAddresses implements Editable<StaticIPAMAddressesBuilder>, KubernetesResource
{
    ...
    @JsonIgnore
    public StaticIPAMAddressesBuilder edit() {
        return new StaticIPAMAddressesBuilder(this);
    }

    @JsonIgnore
    public StaticIPAMAddressesBuilder toBuilder() {
        return edit();
    }
