...
public class PartialSelector implements Editable<PartialSelectorBuilder>, KubernetesResource
{

    @JsonProperty("machineResourceSelector")
    private LabelSelector machineResourceSelector;
    @JsonIgnore
    ...
    public PartialSelector(LabelSelector machineResourceSelector) {
        super();
    ...
    @JsonIgnore
    public PartialSelectorBuilder edit() {
        return new PartialSelectorBuilder(this);
    }

    @JsonIgnore
    public PartialSelectorBuilder toBuilder() {
        return edit();
    }
