...
public class OpenShiftAPIServerSpec implements Editable<OpenShiftAPIServerSpecBuilder>, KubernetesResource
{
    ...
    public OpenShiftAPIServerSpec(String logLevel, String managementState, Object observedConfig, String operatorLogLevel, Object unsupportedConfigOverrides) {
        super();
    ...
    @JsonIgnore
    public OpenShiftAPIServerSpecBuilder edit() {
        return new OpenShiftAPIServerSpecBuilder(this);
    }

    @JsonIgnore
    public OpenShiftAPIServerSpecBuilder toBuilder() {
        return edit();
    }
