...
public class BackupJobReference implements Editable<BackupJobReferenceBuilder>, KubernetesResource
{
    ...
    public BackupJobReference(String name, String namespace) {
        super();
        this.name = name;
    ...
    public BackupJobReferenceBuilder edit() {
        return new BackupJobReferenceBuilder(this);
    }
