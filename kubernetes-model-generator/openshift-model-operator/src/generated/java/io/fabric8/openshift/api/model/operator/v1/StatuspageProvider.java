...
public class StatuspageProvider implements Editable<StatuspageProviderBuilder>, KubernetesResource
{
    ...
    public StatuspageProvider(String pageID) {
        super();
        this.pageID = pageID;
    }
    ...
    @JsonIgnore
    public StatuspageProviderBuilder edit() {
        return new StatuspageProviderBuilder(this);
    }

    @JsonIgnore
    public StatuspageProviderBuilder toBuilder() {
        return edit();
    }
