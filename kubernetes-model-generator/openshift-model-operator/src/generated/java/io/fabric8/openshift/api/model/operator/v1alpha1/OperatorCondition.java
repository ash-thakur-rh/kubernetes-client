...
public class OperatorCondition implements Editable<OperatorConditionBuilder>, KubernetesResource
{
    ...
    public OperatorCondition(String lastTransitionTime, String message, String reason, String status, String type) {
        super();
