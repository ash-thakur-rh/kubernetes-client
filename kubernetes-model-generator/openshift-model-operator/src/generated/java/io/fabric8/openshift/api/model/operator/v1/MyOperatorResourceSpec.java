...
public class MyOperatorResourceSpec implements Editable<MyOperatorResourceSpecBuilder>, KubernetesResource
{
    ...
    public MyOperatorResourceSpec(String logLevel, String managementState, Object observedConfig, String operatorLogLevel, Object unsupportedConfigOverrides) {
        super();
    ...
    @JsonIgnore
    public MyOperatorResourceSpecBuilder edit() {
        return new MyOperatorResourceSpecBuilder(this);
    }

    @JsonIgnore
    public MyOperatorResourceSpecBuilder toBuilder() {
        return edit();
    }
