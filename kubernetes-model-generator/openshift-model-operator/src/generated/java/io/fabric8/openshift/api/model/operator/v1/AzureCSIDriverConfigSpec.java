...
public class AzureCSIDriverConfigSpec implements Editable<AzureCSIDriverConfigSpecBuilder>, KubernetesResource
{

    @JsonProperty("diskEncryptionSet")
    private AzureDiskEncryptionSet diskEncryptionSet;
    @JsonIgnore
    ...
    public AzureCSIDriverConfigSpecBuilder edit() {
        return new AzureCSIDriverConfigSpecBuilder(this);
    }
