...
public class OAuthAPIServerStatus implements Editable<OAuthAPIServerStatusBuilder>, KubernetesResource
{
    ...
    public OAuthAPIServerStatus(Integer latestAvailableRevision) {
        super();
    ...
    @JsonIgnore
    public OAuthAPIServerStatusBuilder edit() {
        return new OAuthAPIServerStatusBuilder(this);
    }

    @JsonIgnore
    public OAuthAPIServerStatusBuilder toBuilder() {
        return edit();
    }
