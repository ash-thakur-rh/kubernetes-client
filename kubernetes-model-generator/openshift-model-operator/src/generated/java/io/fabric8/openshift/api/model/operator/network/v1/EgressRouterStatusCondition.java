...
public class EgressRouterStatusCondition implements Editable<EgressRouterStatusConditionBuilder>, KubernetesResource
{
    ...
    public EgressRouterStatusCondition(String lastTransitionTime, String message, String reason, String status, String type) {
        super();
    ...
    public EgressRouterStatusConditionBuilder edit() {
        return new EgressRouterStatusConditionBuilder(this);
    }
