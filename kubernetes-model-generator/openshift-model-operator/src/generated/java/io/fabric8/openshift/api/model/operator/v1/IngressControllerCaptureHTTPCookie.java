...
public class IngressControllerCaptureHTTPCookie implements Editable<IngressControllerCaptureHTTPCookieBuilder>, KubernetesResource
{
    ...
    public IngressControllerCaptureHTTPCookie(String matchType, Integer maxLength, String name, String namePrefix) {
        super();
    ...
    public IngressControllerCaptureHTTPCookieBuilder edit() {
        return new IngressControllerCaptureHTTPCookieBuilder(this);
    }
