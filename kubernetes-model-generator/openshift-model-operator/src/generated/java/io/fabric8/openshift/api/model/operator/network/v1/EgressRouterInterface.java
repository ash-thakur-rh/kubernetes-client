...
public class EgressRouterInterface implements Editable<EgressRouterInterfaceBuilder>, KubernetesResource
{

    @JsonProperty("macvlan")
    private MacvlanConfig macvlan;
    @JsonIgnore
    ...
    public EgressRouterInterfaceBuilder edit() {
        return new EgressRouterInterfaceBuilder(this);
    }
