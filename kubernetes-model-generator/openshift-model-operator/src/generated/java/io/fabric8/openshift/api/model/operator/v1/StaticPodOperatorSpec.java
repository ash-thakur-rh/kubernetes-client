...
public class StaticPodOperatorSpec implements Editable<StaticPodOperatorSpecBuilder>, KubernetesResource
{
    ...
    public StaticPodOperatorSpec(Integer failedRevisionLimit, String forceRedeploymentReason, String logLevel, String managementState, Object observedConfig, String operatorLogLevel, Integer succeededRevisionLimit, Object unsupportedConfigOverrides) {
        super();
    ...
    public StaticPodOperatorSpecBuilder edit() {
        return new StaticPodOperatorSpecBuilder(this);
    }
