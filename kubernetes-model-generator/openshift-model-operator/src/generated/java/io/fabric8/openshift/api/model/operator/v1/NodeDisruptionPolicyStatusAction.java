...
public class NodeDisruptionPolicyStatusAction implements Editable<NodeDisruptionPolicyStatusActionBuilder>, KubernetesResource
{
     ...
     */
    public NodeDisruptionPolicyStatusAction() {
    }

    public NodeDisruptionPolicyStatusAction(ReloadService reload, RestartService restart, String type) {
        super();
        this.reload = reload;
    ...
    @JsonIgnore
    public NodeDisruptionPolicyStatusActionBuilder edit() {
        return new NodeDisruptionPolicyStatusActionBuilder(this);
    }

    @JsonIgnore
    public NodeDisruptionPolicyStatusActionBuilder toBuilder() {
        return edit();
    }
