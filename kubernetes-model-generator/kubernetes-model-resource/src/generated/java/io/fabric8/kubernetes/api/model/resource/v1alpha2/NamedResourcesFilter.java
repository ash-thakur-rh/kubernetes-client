...
public class NamedResourcesFilter implements Editable<NamedResourcesFilterBuilder>, KubernetesResource
{
    ...
    public NamedResourcesFilter(String selector) {
        super();
    ...
    @JsonIgnore
    public NamedResourcesFilterBuilder edit() {
        return new NamedResourcesFilterBuilder(this);
    }

    @JsonIgnore
    public NamedResourcesFilterBuilder toBuilder() {
        return edit();
    }
