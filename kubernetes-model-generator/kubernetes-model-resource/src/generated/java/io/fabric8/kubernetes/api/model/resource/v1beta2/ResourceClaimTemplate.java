...
public class ResourceClaimTemplate implements Editable<ResourceClaimTemplateBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("kind")
    private String kind = "ResourceClaimTemplate";
    ...
    public ResourceClaimTemplate(String apiVersion, String kind, ObjectMeta metadata, ResourceClaimTemplateSpec spec) {
        super();
    ...
    @JsonIgnore
    public ResourceClaimTemplateBuilder edit() {
        return new ResourceClaimTemplateBuilder(this);
    }

    @JsonIgnore
    public ResourceClaimTemplateBuilder toBuilder() {
        return edit();
    }
