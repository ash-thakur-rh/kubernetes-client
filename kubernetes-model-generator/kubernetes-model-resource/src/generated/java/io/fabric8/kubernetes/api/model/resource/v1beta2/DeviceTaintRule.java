...
public class DeviceTaintRule implements Editable<DeviceTaintRuleBuilder>, HasMetadata
{

    @JsonProperty("apiVersion")
    private String apiVersion = "resource.k8s.io/v1beta2";
    @JsonProperty("kind")
    private String kind = "DeviceTaintRule";
    ...
    @JsonIgnore
    public DeviceTaintRuleBuilder edit() {
        return new DeviceTaintRuleBuilder(this);
    }

    @JsonIgnore
    public DeviceTaintRuleBuilder toBuilder() {
        return edit();
    }
