...
public class OperatorGroup implements Editable<OperatorGroupBuilder>, HasMetadata, Namespaced
{
     ...
     */
    @JsonProperty("spec")
    public OperatorGroupSpec getSpec() {
        return spec;
    }
     ...
     */
    @JsonProperty("spec")
    public void setSpec(OperatorGroupSpec spec) {
        this.spec = spec;
    }
     ...
     */
    @JsonProperty("status")
    public OperatorGroupStatus getStatus() {
        return status;
    }
     ...
     */
    @JsonProperty("status")
    public void setStatus(OperatorGroupStatus status) {
        this.status = status;
    }

    @JsonIgnore
    public OperatorGroupBuilder edit() {
        return new OperatorGroupBuilder(this);
    }

    @JsonIgnore
    public OperatorGroupBuilder toBuilder() {
        return edit();
    }
