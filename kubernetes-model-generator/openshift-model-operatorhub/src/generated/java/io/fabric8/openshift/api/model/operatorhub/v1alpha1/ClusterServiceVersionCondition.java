...
public class ClusterServiceVersionCondition implements Editable<ClusterServiceVersionConditionBuilder>, KubernetesResource
{
    ...
    public ClusterServiceVersionCondition(String lastTransitionTime, String lastUpdateTime, String message, String phase, String reason) {
        super();
    ...
    public ClusterServiceVersionConditionBuilder edit() {
        return new ClusterServiceVersionConditionBuilder(this);
    }
