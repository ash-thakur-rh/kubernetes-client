...
public class APIResourceReference implements Editable<APIResourceReferenceBuilder>, KubernetesResource
{
    ...
    public APIResourceReference(String kind, String name, String version) {
        super();
        this.kind = kind;
        this.name = name;
    ...
    public APIResourceReferenceBuilder edit() {
        return new APIResourceReferenceBuilder(this);
    }
