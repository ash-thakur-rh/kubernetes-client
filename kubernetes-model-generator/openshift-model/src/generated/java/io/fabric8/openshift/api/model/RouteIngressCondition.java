...
public class RouteIngressCondition implements Editable<RouteIngressConditionBuilder>, KubernetesResource
{
    ...
    public RouteIngressCondition(String lastTransitionTime, String message, String reason, String status, String type) {
        super();
    ...
    public RouteIngressConditionBuilder edit() {
        return new RouteIngressConditionBuilder(this);
    }
