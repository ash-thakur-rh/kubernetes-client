...
/**
 * ImageStreamLayers describes information about the layers referenced by images in this image stream.<br><p> <br><p> Compatibility level 1: Stable within a major release for a minimum of 12 months or 3 minor releases (whichever is longer).
 */
...
public class ImageStreamLayers implements Editable<ImageStreamLayersBuilder>, HasMetadata, Namespaced
{
    ...
    private Map<String, ImageLayerData> blobs = new LinkedHashMap<>();
    @JsonProperty("images")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    ...
    public ImageStreamLayers(String apiVersion, Map<String, ImageLayerData> blobs, Map<String, ImageBlobReferences> images, String kind, ObjectMeta metadata) {
        super();
