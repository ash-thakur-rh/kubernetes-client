...
/**
 * ProjectRequest is the set of options necessary to fully qualify a project request<br><p> <br><p> Compatibility level 1: Stable within a major release for a minimum of 12 months or 3 minor releases (whichever is longer).
 */
...
public class ProjectRequest implements Editable<ProjectRequestBuilder>, HasMetadata
{
    ...
    @JsonIgnore
    public ProjectRequestBuilder toBuilder() {
        return edit();
    }
