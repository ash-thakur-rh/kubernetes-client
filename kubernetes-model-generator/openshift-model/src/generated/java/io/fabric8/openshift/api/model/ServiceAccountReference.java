...
public class ServiceAccountReference implements Editable<ServiceAccountReferenceBuilder>, KubernetesResource
{
    ...
    public ServiceAccountReference(String name, String namespace) {
        super();
        this.name = name;
    ...
    public ServiceAccountReferenceBuilder edit() {
        return new ServiceAccountReferenceBuilder(this);
    }
