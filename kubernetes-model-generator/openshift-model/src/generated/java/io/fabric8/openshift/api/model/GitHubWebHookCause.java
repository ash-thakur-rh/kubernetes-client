...
public class GitHubWebHookCause implements Editable<GitHubWebHookCauseBuilder>, KubernetesResource
{
    ...
    @JsonIgnore
    public GitHubWebHookCauseBuilder edit() {
        return new GitHubWebHookCauseBuilder(this);
    }

    @JsonIgnore
    public GitHubWebHookCauseBuilder toBuilder() {
        return edit();
    }
