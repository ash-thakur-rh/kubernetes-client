...
public class RouteHTTPHeaderActionUnion implements Editable<RouteHTTPHeaderActionUnionBuilder>, KubernetesResource
{

    @JsonProperty("set")
    private RouteSetHTTPHeader set;
    @JsonProperty("type")
    private String type;
    @JsonIgnore
    ...
    public RouteHTTPHeaderActionUnionBuilder edit() {
        return new RouteHTTPHeaderActionUnionBuilder(this);
    }
