...
public class DeploymentTriggerPolicy implements Editable<DeploymentTriggerPolicyBuilder>, KubernetesResource
{
    ...
    @JsonIgnore
    public DeploymentTriggerPolicyBuilder edit() {
        return new DeploymentTriggerPolicyBuilder(this);
    }

    @JsonIgnore
    public DeploymentTriggerPolicyBuilder toBuilder() {
        return edit();
    }
