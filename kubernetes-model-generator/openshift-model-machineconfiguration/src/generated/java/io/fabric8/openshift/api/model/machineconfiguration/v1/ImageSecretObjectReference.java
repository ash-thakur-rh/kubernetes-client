...
public class ImageSecretObjectReference implements Editable<ImageSecretObjectReferenceBuilder>, KubernetesResource
{
    ...
    public ImageSecretObjectReference(String name) {
        super();
        this.name = name;
    }
    ...
    @JsonIgnore
    public ImageSecretObjectReferenceBuilder edit() {
        return new ImageSecretObjectReferenceBuilder(this);
    }

    @JsonIgnore
    public ImageSecretObjectReferenceBuilder toBuilder() {
        return edit();
    }
