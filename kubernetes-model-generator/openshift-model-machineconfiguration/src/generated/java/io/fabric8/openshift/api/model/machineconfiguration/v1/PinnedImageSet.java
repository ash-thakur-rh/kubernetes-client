...
/**
 * PinnedImageSet describes a set of images that should be pinned by CRI-O and pulled to the nodes which are members of the declared MachineConfigPools.<br><p> <br><p> Compatibility level 1: Stable within a major release for a minimum of 12 months or 3 minor releases (whichever is longer).
 */
...
public class PinnedImageSet implements Editable<PinnedImageSetBuilder>, HasMetadata
{
    ...
    public PinnedImageSet(String apiVersion, String kind, ObjectMeta metadata, PinnedImageSetSpec spec) {
        super();
