...
/**
 * ControllerConfig describes configuration for MachineConfigController. This is currently only used to drive the MachineConfig objects generated by the TemplateController.<br><p> <br><p> Compatibility level 1: Stable within a major release for a minimum of 12 months or 3 minor releases (whichever is longer).
 */
...
public class ControllerConfig implements Editable<ControllerConfigBuilder>, HasMetadata
{
     ...
     */
    @JsonProperty("spec")
    public void setSpec(ControllerConfigSpec spec) {
        this.spec = spec;
    }
     ...
     */
    @JsonProperty("status")
    public void setStatus(ControllerConfigStatus status) {
        this.status = status;
    }
