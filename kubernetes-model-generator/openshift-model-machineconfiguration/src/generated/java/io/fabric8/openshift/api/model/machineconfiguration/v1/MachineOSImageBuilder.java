...
public class MachineOSImageBuilder implements Editable<MachineOSImageBuilderBuilder>, KubernetesResource
{
    ...
    /**
     * imageBuilderType specifies the backend to be used to build the image. Valid options are: Job<br><p> <br><p> Possible enum values:<br><p>  - `"Job"` describes that the machine-os-builder will use a Job to spin up a custom pod builder that uses buildah
     */
    @JsonProperty("imageBuilderType")
