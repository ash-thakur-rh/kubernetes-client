...
public class StatefulSet implements Editable<StatefulSetBuilder>, HasMetadata, Namespaced
{
    ...
    public StatefulSet(String apiVersion, String kind, ObjectMeta metadata, StatefulSetSpec spec, StatefulSetStatus status) {
        super();
    ...
    @JsonIgnore
    public StatefulSetBuilder edit() {
        return new StatefulSetBuilder(this);
    }

    @JsonIgnore
    public StatefulSetBuilder toBuilder() {
        return edit();
    }
