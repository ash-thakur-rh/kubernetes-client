...
public class JSONSchemaPropsOrArraySerDe {
  ...
  public static class Serializer extends ValueSerializer<JSONSchemaPropsOrArray> {
    @Override
    public void serialize(JSONSchemaPropsOrArray jsonSchemaPropsOrArray,
      ...
      if (jsonSchemaPropsOrArray.getJSONSchemas() != null && !jsonSchemaPropsOrArray.getJSONSchemas().isEmpty()) {
        ...
        for (JSONSchemaProps schema : jsonSchemaPropsOrArray.getJSONSchemas()) {
          jsonGenerator.writePOJO(schema);
        }
        jsonGenerator.writeEndArray();
      } else {
        jsonGenerator.writePOJO(jsonSchemaPropsOrArray.getSchema());
      }
    }
  }

  public static class Deserializer extends ValueDeserializer<JSONSchemaPropsOrArray> {

    @Override
    public JSONSchemaPropsOrArray deserialize(JsonParser jsonParser, DeserializationContext deserializationContext)
{
