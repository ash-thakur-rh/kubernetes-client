...
public class ClusterAutoscalerSpecScaleUp implements Editable<ClusterAutoscalerSpecScaleUpBuilder>, KubernetesResource
{
     ...
     */
    public ClusterAutoscalerSpecScaleUp() {
    }

    public ClusterAutoscalerSpecScaleUp(String newPodScaleUpDelay) {
        super();
    ...
    @JsonIgnore
    public ClusterAutoscalerSpecScaleUpBuilder edit() {
        return new ClusterAutoscalerSpecScaleUpBuilder(this);
    }

    @JsonIgnore
    public ClusterAutoscalerSpecScaleUpBuilder toBuilder() {
        return edit();
    }
