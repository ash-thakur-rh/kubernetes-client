...
public class ClusterClaim implements Editable<ClusterClaimBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("status")
    private ClusterClaimStatus status;
    @JsonIgnore
    ...
    public ClusterClaim(String apiVersion, String kind, ObjectMeta metadata, ClusterClaimSpec spec, ClusterClaimStatus status) {
        super();
     ...
     */
    @JsonProperty("status")
    public ClusterClaimStatus getStatus() {
        return status;
    }
     ...
     */
    @JsonProperty("status")
    public void setStatus(ClusterClaimStatus status) {
        this.status = status;
    }
