...
public class GCPDNSZoneStatus implements Editable<GCPDNSZoneStatusBuilder>, KubernetesResource
{
    ...
    public GCPDNSZoneStatus(String zoneName) {
        super();
    ...
    @JsonIgnore
    public GCPDNSZoneStatusBuilder edit() {
        return new GCPDNSZoneStatusBuilder(this);
    }

    @JsonIgnore
    public GCPDNSZoneStatusBuilder toBuilder() {
        return edit();
    }
