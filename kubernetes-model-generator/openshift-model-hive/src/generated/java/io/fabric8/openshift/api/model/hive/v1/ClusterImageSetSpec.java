...
public class ClusterImageSetSpec implements Editable<ClusterImageSetSpecBuilder>, KubernetesResource
{
    ...
    @JsonIgnore
    public ClusterImageSetSpecBuilder edit() {
        return new ClusterImageSetSpecBuilder(this);
    }

    @JsonIgnore
    public ClusterImageSetSpecBuilder toBuilder() {
        return edit();
    }
