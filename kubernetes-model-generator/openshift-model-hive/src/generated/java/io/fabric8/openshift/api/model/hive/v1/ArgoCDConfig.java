...
public class ArgoCDConfig implements Editable<ArgoCDConfigBuilder>, KubernetesResource
{
    ...
    public ArgoCDConfig(Boolean enabled, String namespace) {
        super();
    ...
    public ArgoCDConfigBuilder edit() {
        return new ArgoCDConfigBuilder(this);
    }
