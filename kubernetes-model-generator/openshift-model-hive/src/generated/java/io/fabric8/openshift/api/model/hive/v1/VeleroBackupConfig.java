...
public class VeleroBackupConfig implements Editable<VeleroBackupConfigBuilder>, KubernetesResource
{
    ...
    public VeleroBackupConfig(Boolean enabled, String namespace) {
        super();
    ...
    @JsonIgnore
    public VeleroBackupConfigBuilder edit() {
        return new VeleroBackupConfigBuilder(this);
    }

    @JsonIgnore
    public VeleroBackupConfigBuilder toBuilder() {
        return edit();
    }
