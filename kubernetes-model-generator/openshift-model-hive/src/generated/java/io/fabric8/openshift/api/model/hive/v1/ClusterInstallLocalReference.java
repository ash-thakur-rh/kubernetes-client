...
public class ClusterInstallLocalReference implements Editable<ClusterInstallLocalReferenceBuilder>, KubernetesResource
{
    ...
    public ClusterInstallLocalReference(String group, String kind, String name, String version) {
        super();
        this.group = group;
        this.kind = kind;
        this.name = name;
    ...
    public ClusterInstallLocalReferenceBuilder edit() {
        return new ClusterInstallLocalReferenceBuilder(this);
    }
