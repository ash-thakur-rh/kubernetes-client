...
public class InventoryEntry implements Editable<InventoryEntryBuilder>, KubernetesResource
{
    ...
    public InventoryEntry(String kind, String name) {
        super();
        this.kind = kind;
        this.name = name;
    }
    ...
    public InventoryEntryBuilder edit() {
        return new InventoryEntryBuilder(this);
    }
