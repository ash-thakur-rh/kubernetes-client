...
public class ConfidentialVM implements Editable<ConfidentialVMBuilder>, KubernetesResource
{
    ...
    public ConfidentialVM(UEFISettings uefiSettings) {
        super();
    ...
    @JsonIgnore
    public ConfidentialVMBuilder edit() {
        return new ConfidentialVMBuilder(this);
    }

    @JsonIgnore
    public ConfidentialVMBuilder toBuilder() {
        return edit();
    }
