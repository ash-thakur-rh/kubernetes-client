...
public class NutanixFailureDomainReference implements Editable<NutanixFailureDomainReferenceBuilder>, KubernetesResource
{
    ...
    public NutanixFailureDomainReference(String name) {
        super();
        this.name = name;
    }
    ...
    @JsonIgnore
    public NutanixFailureDomainReferenceBuilder edit() {
        return new NutanixFailureDomainReferenceBuilder(this);
    }

    @JsonIgnore
    public NutanixFailureDomainReferenceBuilder toBuilder() {
        return edit();
    }
