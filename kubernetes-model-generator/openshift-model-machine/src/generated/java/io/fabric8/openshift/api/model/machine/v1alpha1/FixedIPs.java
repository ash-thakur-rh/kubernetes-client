...
public class FixedIPs implements Editable<FixedIPsBuilder>, KubernetesResource
{
    ...
    public FixedIPs(String ipAddress, String subnetID) {
        super();
    ...
    public FixedIPsBuilder edit() {
        return new FixedIPsBuilder(this);
    }
