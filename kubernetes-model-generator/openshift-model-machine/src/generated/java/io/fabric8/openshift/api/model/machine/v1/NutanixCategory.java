...
public class NutanixCategory implements Editable<NutanixCategoryBuilder>, KubernetesResource
{
    ...
    public NutanixCategory(String key, String value) {
        super();
        this.key = key;
        this.value = value;
    }
    ...
    @JsonIgnore
    public NutanixCategoryBuilder edit() {
        return new NutanixCategoryBuilder(this);
    }

    @JsonIgnore
    public NutanixCategoryBuilder toBuilder() {
        return edit();
    }
