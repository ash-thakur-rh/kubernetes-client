...
public class VSphereDisk implements Editable<VSphereDiskBuilder>, KubernetesResource
{
    ...
    public VSphereDisk(String name, String provisioningMode, Integer sizeGiB) {
        super();
        this.name = name;
    ...
    public VSphereDiskBuilder edit() {
        return new VSphereDiskBuilder(this);
    }
