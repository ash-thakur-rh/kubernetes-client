...
public class DiskEncryptionSetParameters implements Editable<DiskEncryptionSetParametersBuilder>, KubernetesResource
{
    ...
    public DiskEncryptionSetParameters(String id) {
        super();
        this.id = id;
    }
    ...
    @JsonIgnore
    public DiskEncryptionSetParametersBuilder edit() {
        return new DiskEncryptionSetParametersBuilder(this);
    }

    @JsonIgnore
    public DiskEncryptionSetParametersBuilder toBuilder() {
        return edit();
    }
