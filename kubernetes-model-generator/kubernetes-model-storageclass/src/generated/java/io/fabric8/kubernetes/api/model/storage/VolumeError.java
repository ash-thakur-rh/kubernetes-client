...
public class VolumeError implements Editable<VolumeErrorBuilder>, KubernetesResource
{
    ...
    /**
     * errorCode is a numeric gRPC code representing the error encountered during Attach or Detach operations.<br><p> <br><p> This field requires the MutableCSINodeAllocatableCount feature gate being enabled to be set.
     */
    @JsonProperty("errorCode")
