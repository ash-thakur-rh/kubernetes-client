...
public class StorageStateSpec implements Editable<StorageStateSpecBuilder>, KubernetesResource
{
    ...
    @JsonIgnore
    public StorageStateSpecBuilder edit() {
        return new StorageStateSpecBuilder(this);
    }

    @JsonIgnore
    public StorageStateSpecBuilder toBuilder() {
        return edit();
    }
