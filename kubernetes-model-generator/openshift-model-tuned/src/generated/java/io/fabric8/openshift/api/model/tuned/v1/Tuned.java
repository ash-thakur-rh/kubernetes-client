...
public class Tuned implements Editable<TunedBuilder>, HasMetadata, Namespaced
{

    @JsonProperty("apiVersion")
    private String apiVersion = "tuned.openshift.io/v1";
    @JsonProperty("kind")
    private String kind = "Tuned";
    @JsonProperty("metadata")
    private ObjectMeta metadata;
    @JsonProperty("spec")
    private TunedSpec spec;
    @JsonProperty("status")
    private TunedStatus status;
    @JsonIgnore
    ...
    public Tuned(String apiVersion, String kind, ObjectMeta metadata, TunedSpec spec, TunedStatus status) {
        super();
     ...
     */
    @JsonProperty("spec")
    public void setSpec(TunedSpec spec) {
        this.spec = spec;
    }
     ...
     */
    @JsonProperty("status")
    public void setStatus(TunedStatus status) {
        this.status = status;
    }

    @JsonIgnore
    public TunedBuilder edit() {
        return new TunedBuilder(this);
    }

    @JsonIgnore
    public TunedBuilder toBuilder() {
        return edit();
    }
