...
public class ConsoleExternalLogLink implements Editable<ConsoleExternalLogLinkBuilder>, HasMetadata
{
    ...
    public ConsoleExternalLogLink(String apiVersion, String kind, ObjectMeta metadata, ConsoleExternalLogLinkSpec spec) {
        super();
    ...
    @JsonIgnore
    public ConsoleExternalLogLinkBuilder edit() {
        return new ConsoleExternalLogLinkBuilder(this);
    }

    @JsonIgnore
    public ConsoleExternalLogLinkBuilder toBuilder() {
        return edit();
    }
