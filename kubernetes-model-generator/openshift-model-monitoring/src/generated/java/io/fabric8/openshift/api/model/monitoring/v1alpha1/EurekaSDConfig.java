...
public class EurekaSDConfig implements Editable<EurekaSDConfigBuilder>, KubernetesResource
{
    ...
    @JsonIgnore
    public EurekaSDConfigBuilder edit() {
        return new EurekaSDConfigBuilder(this);
    }

    @JsonIgnore
    public EurekaSDConfigBuilder toBuilder() {
        return edit();
    }
