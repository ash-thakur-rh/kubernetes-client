...
public class HTTPSDConfig implements Editable<HTTPSDConfigBuilder>, KubernetesResource
{
    ...
    public HTTPSDConfig(SafeAuthorization authorization, BasicAuth basicAuth, Boolean enableHTTP2, Boolean followRedirects, String noProxy, OAuth2 oauth2, Map<String, List<SecretKeySelector>> proxyConnectHeader, Boolean proxyFromEnvironment, String proxyUrl, String refreshInterval, SafeTLSConfig tlsConfig, String url) {
        super();
    ...
    @JsonIgnore
    public HTTPSDConfigBuilder edit() {
        return new HTTPSDConfigBuilder(this);
    }

    @JsonIgnore
    public HTTPSDConfigBuilder toBuilder() {
        return edit();
    }
