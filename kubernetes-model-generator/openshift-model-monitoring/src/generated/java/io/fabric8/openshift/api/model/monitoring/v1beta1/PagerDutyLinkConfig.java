...
public class PagerDutyLinkConfig implements Editable<PagerDutyLinkConfigBuilder>, KubernetesResource
{
    ...
    public PagerDutyLinkConfig(String alt, String href) {
        super();
        this.alt = alt;
        this.href = href;
    }
    ...
    public PagerDutyLinkConfigBuilder edit() {
        return new PagerDutyLinkConfigBuilder(this);
    }
