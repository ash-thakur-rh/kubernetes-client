...
public class ShardRetentionPolicy implements Editable<ShardRetentionPolicyBuilder>, KubernetesResource
{

    @JsonProperty("retain")
    private RetainConfig retain;
    ...
    public ShardRetentionPolicyBuilder edit() {
        return new ShardRetentionPolicyBuilder(this);
    }
