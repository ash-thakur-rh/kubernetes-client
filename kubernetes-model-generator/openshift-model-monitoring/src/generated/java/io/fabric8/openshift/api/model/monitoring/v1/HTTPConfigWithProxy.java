...
public class HTTPConfigWithProxy implements Editable<HTTPConfigWithProxyBuilder>, KubernetesResource
{
    ...
    @JsonIgnore
    public HTTPConfigWithProxyBuilder edit() {
        return new HTTPConfigWithProxyBuilder(this);
    }

    @JsonIgnore
    public HTTPConfigWithProxyBuilder toBuilder() {
        return edit();
    }
