...
public class ProbeTargets implements Editable<ProbeTargetsBuilder>, KubernetesResource
{

    @JsonProperty("ingress")
    private ProbeTargetIngress ingress;
    @JsonProperty("staticConfig")
    private ProbeTargetStaticConfig staticConfig;
    @JsonIgnore
    ...
    @JsonIgnore
    public ProbeTargetsBuilder edit() {
        return new ProbeTargetsBuilder(this);
    }

    @JsonIgnore
    public ProbeTargetsBuilder toBuilder() {
        return edit();
    }
