...
public class RocketChatActionConfig implements Editable<RocketChatActionConfigBuilder>, KubernetesResource
{
    ...
    public RocketChatActionConfig(String msg, String text, String url) {
        super();
        this.msg = msg;
        this.text = text;
        this.url = url;
    ...
    public RocketChatActionConfigBuilder edit() {
        return new RocketChatActionConfigBuilder(this);
    }
