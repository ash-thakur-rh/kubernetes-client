...
public class RocketChatFieldConfig implements Editable<RocketChatFieldConfigBuilder>, KubernetesResource
{
     ...
     */
    public RocketChatFieldConfig() {
    }

    public RocketChatFieldConfig(Boolean _short, String title, String value) {
        super();
        this._short = _short;
        this.title = title;
        this.value = value;
    ...
    public RocketChatFieldConfigBuilder edit() {
        return new RocketChatFieldConfigBuilder(this);
    }
