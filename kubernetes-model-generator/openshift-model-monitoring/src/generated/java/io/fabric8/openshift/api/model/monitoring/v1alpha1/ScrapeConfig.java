...
public class ScrapeConfig implements Editable<ScrapeConfigBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("kind")
    private String kind = "ScrapeConfig";
     ...
     */
    @JsonProperty("spec")
    public ScrapeConfigSpec getSpec() {
        return spec;
    }
    ...
    @JsonIgnore
    public ScrapeConfigBuilder edit() {
        return new ScrapeConfigBuilder(this);
    }

    @JsonIgnore
    public ScrapeConfigBuilder toBuilder() {
        return edit();
    }
