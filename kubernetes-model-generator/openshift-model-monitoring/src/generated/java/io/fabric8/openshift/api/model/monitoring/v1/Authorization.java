...
public class Authorization implements Editable<AuthorizationBuilder>, KubernetesResource
{
    ...
    public Authorization(SecretKeySelector credentials, String credentialsFile, String type) {
        super();
    ...
    @JsonIgnore
    public AuthorizationBuilder edit() {
        return new AuthorizationBuilder(this);
    }

    @JsonIgnore
    public AuthorizationBuilder toBuilder() {
        return edit();
    }
