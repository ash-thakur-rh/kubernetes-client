...
public class ConfigResourceCondition implements Editable<ConfigResourceConditionBuilder>, KubernetesResource
{
     ...
     */
    public ConfigResourceCondition() {
    }

    public ConfigResourceCondition(String lastTransitionTime, String message, Long observedGeneration, String reason, String status, String type) {
        super();
    ...
    public ConfigResourceConditionBuilder edit() {
        return new ConfigResourceConditionBuilder(this);
    }
