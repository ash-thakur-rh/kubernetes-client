...
public class HostUpdatePolicy implements Editable<HostUpdatePolicyBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("spec")
    private HostUpdatePolicySpec spec;
    @JsonProperty("status")
    private HostUpdatePolicyStatus status;
    @JsonIgnore
     ...
     */
    public HostUpdatePolicy() {
    }

    public HostUpdatePolicy(String apiVersion, String kind, ObjectMeta metadata, HostUpdatePolicySpec spec, HostUpdatePolicyStatus status) {
        super();
    ...
    @JsonIgnore
    public HostUpdatePolicyBuilder edit() {
        return new HostUpdatePolicyBuilder(this);
    }

    @JsonIgnore
    public HostUpdatePolicyBuilder toBuilder() {
        return edit();
    }
