...
public class Metal3MachineTemplateResource implements Editable<Metal3MachineTemplateResourceBuilder>, KubernetesResource
{
    ...
    public Metal3MachineTemplateResource(Metal3MachineSpec spec) {
        super();
        this.spec = spec;
    }
    ...
    @JsonIgnore
    public Metal3MachineTemplateResourceBuilder edit() {
        return new Metal3MachineTemplateResourceBuilder(this);
    }

    @JsonIgnore
    public Metal3MachineTemplateResourceBuilder toBuilder() {
        return edit();
    }
