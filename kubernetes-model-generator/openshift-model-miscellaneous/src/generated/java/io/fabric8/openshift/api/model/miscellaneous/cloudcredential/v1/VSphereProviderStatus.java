...
public class VSphereProviderStatus implements Editable<VSphereProviderStatusBuilder>, KubernetesResource, Namespaced
{
    ...
    public VSphereProviderStatus(String apiVersion, String kind, String secretLastResourceVersion) {
        super();
    ...
    @JsonIgnore
    public VSphereProviderStatusBuilder edit() {
        return new VSphereProviderStatusBuilder(this);
    }

    @JsonIgnore
    public VSphereProviderStatusBuilder toBuilder() {
        return edit();
    }
