...
public class AWSProviderStatus implements Editable<AWSProviderStatusBuilder>, KubernetesResource, Namespaced
{
     ...
     */
    public AWSProviderStatus() {
    }

    public AWSProviderStatus(String apiVersion, String kind, String policy, String user) {
        super();
    ...
    @JsonIgnore
    public AWSProviderStatusBuilder edit() {
        return new AWSProviderStatusBuilder(this);
    }

    @JsonIgnore
    public AWSProviderStatusBuilder toBuilder() {
        return edit();
    }
