...
public class ResourceAttribute implements Editable<ResourceAttributeBuilder>, KubernetesResource
{
    ...
    public ResourceAttribute(String name, String operator, String value) {
        super();
        this.name = name;
    ...
    public ResourceAttributeBuilder edit() {
        return new ResourceAttributeBuilder(this);
    }
