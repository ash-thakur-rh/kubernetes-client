...
public class FirmwareUpdate implements Editable<FirmwareUpdateBuilder>, KubernetesResource
{
    ...
    public FirmwareUpdate(String component, String url) {
        super();
    ...
    @JsonIgnore
    public FirmwareUpdateBuilder edit() {
        return new FirmwareUpdateBuilder(this);
    }

    @JsonIgnore
    public FirmwareUpdateBuilder toBuilder() {
        return edit();
    }
