...
public class MetaDataObjectName implements Editable<MetaDataObjectNameBuilder>, KubernetesResource
{
     ...
     */
    public MetaDataObjectName() {
    }

    public MetaDataObjectName(String key, String object) {
        super();
        this.key = key;
        this.object = object;
    }
    ...
    public MetaDataObjectNameBuilder edit() {
        return new MetaDataObjectNameBuilder(this);
    }
