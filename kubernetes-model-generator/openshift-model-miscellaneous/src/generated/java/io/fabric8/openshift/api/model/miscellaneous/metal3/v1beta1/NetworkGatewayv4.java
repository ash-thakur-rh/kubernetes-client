...
public class NetworkGatewayv4 implements Editable<NetworkGatewayv4Builder>, KubernetesResource
{
    ...
    @JsonIgnore
    public NetworkGatewayv4Builder edit() {
        return new NetworkGatewayv4Builder(this);
    }

    @JsonIgnore
    public NetworkGatewayv4Builder toBuilder() {
        return edit();
    }
