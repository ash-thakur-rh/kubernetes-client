...
public class Metal3Remediation implements Editable<Metal3RemediationBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("kind")
    private String kind = "Metal3Remediation";
     ...
     */
    public Metal3Remediation() {
    }

    public Metal3Remediation(String apiVersion, String kind, ObjectMeta metadata, Metal3RemediationSpec spec, Metal3RemediationStatus status) {
        super();
    ...
    @JsonIgnore
    public Metal3RemediationBuilder edit() {
        return new Metal3RemediationBuilder(this);
    }

    @JsonIgnore
    public Metal3RemediationBuilder toBuilder() {
        return edit();
    }
