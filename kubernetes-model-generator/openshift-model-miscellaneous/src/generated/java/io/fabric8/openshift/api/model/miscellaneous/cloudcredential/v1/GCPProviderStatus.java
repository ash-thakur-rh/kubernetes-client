...
public class GCPProviderStatus implements Editable<GCPProviderStatusBuilder>, KubernetesResource, Namespaced
{
    ...
    public GCPProviderStatus(String apiVersion, String kind, String roleID, String serviceAccountID) {
        super();
    ...
    @JsonIgnore
    public GCPProviderStatusBuilder edit() {
        return new GCPProviderStatusBuilder(this);
    }

    @JsonIgnore
    public GCPProviderStatusBuilder toBuilder() {
        return edit();
    }
