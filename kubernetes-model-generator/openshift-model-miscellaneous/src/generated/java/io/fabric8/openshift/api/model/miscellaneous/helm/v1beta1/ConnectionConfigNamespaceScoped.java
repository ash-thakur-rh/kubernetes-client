...
public class ConnectionConfigNamespaceScoped implements Editable<ConnectionConfigNamespaceScopedBuilder>, KubernetesResource
{
    ...
    @JsonIgnore
    public ConnectionConfigNamespaceScopedBuilder edit() {
        return new ConnectionConfigNamespaceScopedBuilder(this);
    }

    @JsonIgnore
    public ConnectionConfigNamespaceScopedBuilder toBuilder() {
        return edit();
    }
