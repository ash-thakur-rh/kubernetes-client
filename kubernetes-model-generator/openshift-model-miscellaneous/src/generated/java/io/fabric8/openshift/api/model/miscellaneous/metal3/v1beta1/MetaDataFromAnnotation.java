...
public class MetaDataFromAnnotation implements Editable<MetaDataFromAnnotationBuilder>, KubernetesResource
{
    ...
    public MetaDataFromAnnotation(String annotation, String key, String object) {
        super();
    ...
    public MetaDataFromAnnotationBuilder edit() {
        return new MetaDataFromAnnotationBuilder(this);
    }
