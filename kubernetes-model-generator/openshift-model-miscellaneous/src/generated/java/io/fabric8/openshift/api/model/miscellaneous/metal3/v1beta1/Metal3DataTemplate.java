...
public class Metal3DataTemplate implements Editable<Metal3DataTemplateBuilder>, HasMetadata, Namespaced
{
    ...
    @JsonProperty("spec")
    private Metal3DataTemplateSpec spec;
    @JsonProperty("status")
    private Metal3DataTemplateStatus status;
    @JsonIgnore
     ...
     */
    public Metal3DataTemplate() {
    }

    public Metal3DataTemplate(String apiVersion, String kind, ObjectMeta metadata, Metal3DataTemplateSpec spec, Metal3DataTemplateStatus status) {
        super();
    ...
    @JsonIgnore
    public Metal3DataTemplateBuilder edit() {
        return new Metal3DataTemplateBuilder(this);
    }

    @JsonIgnore
    public Metal3DataTemplateBuilder toBuilder() {
        return edit();
    }
