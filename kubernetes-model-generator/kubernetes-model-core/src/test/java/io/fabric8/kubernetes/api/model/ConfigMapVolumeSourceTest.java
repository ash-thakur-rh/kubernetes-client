...
class ConfigMapVolumeSourceTest {
  ...
  void deserializationWithOctalValueShouldWorkAsExpected() throws IOException {
    // Given
    final String originalJson = Helper.loadJson("/configmapvolumesource.json");

    // When
    ConfigMapVolumeSource configMapVolumeSource = objectMapper.readValue(originalJson, ConfigMapVolumeSource.class);
