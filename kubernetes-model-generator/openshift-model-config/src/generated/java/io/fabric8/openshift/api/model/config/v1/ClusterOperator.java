...
/**
 * ClusterOperator is the Custom Resource object which holds the current state of an operator. This object is used by operators to convey their state to the rest of the cluster.<br><p> <br><p> Compatibility level 1: Stable within a major release for a minimum of 12 months or 3 minor releases (whichever is longer).
 */
...
public class ClusterOperator implements Editable<ClusterOperatorBuilder>, HasMetadata
{

    @JsonProperty("apiVersion")
    private String apiVersion = "config.openshift.io/v1";
    @JsonProperty("kind")
    private String kind = "ClusterOperator";
     ...
     */
    @JsonProperty("status")
    public void setStatus(ClusterOperatorStatus status) {
        this.status = status;
    }

    @JsonIgnore
    public ClusterOperatorBuilder edit() {
        return new ClusterOperatorBuilder(this);
    }

    @JsonIgnore
    public ClusterOperatorBuilder toBuilder() {
        return edit();
    }
