...
public class IBMCloudServiceEndpoint implements Editable<IBMCloudServiceEndpointBuilder>, KubernetesResource
{
    ...
    public IBMCloudServiceEndpoint(String name, String url) {
        super();
        this.name = name;
        this.url = url;
    }
    ...
    public IBMCloudServiceEndpointBuilder edit() {
        return new IBMCloudServiceEndpointBuilder(this);
    }
