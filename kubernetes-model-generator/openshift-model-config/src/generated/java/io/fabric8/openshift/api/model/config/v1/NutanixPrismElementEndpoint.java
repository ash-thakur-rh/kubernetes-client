...
public class NutanixPrismElementEndpoint implements Editable<NutanixPrismElementEndpointBuilder>, KubernetesResource
{

    @JsonProperty("endpoint")
    private NutanixPrismEndpoint endpoint;
    @JsonProperty("name")
    private String name;
    @JsonIgnore
    ...
    public NutanixPrismElementEndpointBuilder edit() {
        return new NutanixPrismElementEndpointBuilder(this);
    }
