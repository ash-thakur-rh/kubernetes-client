...
public class OvirtPlatformLoadBalancer implements Editable<OvirtPlatformLoadBalancerBuilder>, KubernetesResource
{
    ...
    public OvirtPlatformLoadBalancer(String type) {
        super();
        this.type = type;
    }
    ...
    @JsonIgnore
    public OvirtPlatformLoadBalancerBuilder edit() {
        return new OvirtPlatformLoadBalancerBuilder(this);
    }

    @JsonIgnore
    public OvirtPlatformLoadBalancerBuilder toBuilder() {
        return edit();
    }
