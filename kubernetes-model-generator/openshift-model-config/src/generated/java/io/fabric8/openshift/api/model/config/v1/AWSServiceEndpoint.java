...
public class AWSServiceEndpoint implements Editable<AWSServiceEndpointBuilder>, KubernetesResource
{
    ...
    public AWSServiceEndpoint(String name, String url) {
        super();
        this.name = name;
        this.url = url;
    }
    ...
    public AWSServiceEndpointBuilder edit() {
        return new AWSServiceEndpointBuilder(this);
    }
