...
public class GCPResourceLabel implements Editable<GCPResourceLabelBuilder>, KubernetesResource
{
    ...
    public GCPResourceLabel(String key, String value) {
        super();
        this.key = key;
        this.value = value;
    }
    ...
    public GCPResourceLabelBuilder edit() {
        return new GCPResourceLabelBuilder(this);
    }
