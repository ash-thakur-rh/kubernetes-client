...
public class OperandVersion implements Editable<OperandVersionBuilder>, KubernetesResource
{
    ...
    public OperandVersion(String name, String version) {
        super();
        this.name = name;
    ...
    public OperandVersionBuilder edit() {
        return new OperandVersionBuilder(this);
    }
