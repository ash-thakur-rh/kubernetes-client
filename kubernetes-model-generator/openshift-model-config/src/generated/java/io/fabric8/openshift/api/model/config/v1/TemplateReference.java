...
public class TemplateReference implements Editable<TemplateReferenceBuilder>, KubernetesResource
{
    ...
    @JsonIgnore
    public TemplateReferenceBuilder edit() {
        return new TemplateReferenceBuilder(this);
    }

    @JsonIgnore
    public TemplateReferenceBuilder toBuilder() {
        return edit();
    }
