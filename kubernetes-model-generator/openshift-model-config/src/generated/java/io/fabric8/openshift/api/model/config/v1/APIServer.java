...
public class APIServer implements Editable<APIServerBuilder>, HasMetadata
{
     ...
     */
    @JsonProperty("spec")
    public void setSpec(APIServerSpec spec) {
        this.spec = spec;
    }
    ...
    @JsonIgnore
    public APIServerBuilder edit() {
        return new APIServerBuilder(this);
    }

    @JsonIgnore
    public APIServerBuilder toBuilder() {
        return edit();
    }
