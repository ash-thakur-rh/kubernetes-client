...
/**
 * Build configures the behavior of OpenShift builds for the entire cluster. This includes default settings that can be overridden in BuildConfig objects, and overrides which are applied to all builds.<br><p> <br><p> The canonical name is "cluster"<br><p> <br><p> Compatibility level 1: Stable within a major release for a minimum of 12 months or 3 minor releases (whichever is longer).
 */
...
public class Build implements Editable<BuildBuilder>, HasMetadata
{
    ...
    public Build(String apiVersion, String kind, ObjectMeta metadata, BuildSpec spec) {
        super();
