...
public class PriorityLevelConfiguration implements Editable<PriorityLevelConfigurationBuilder>, HasMetadata
{
    ...
    public PriorityLevelConfiguration(String apiVersion, String kind, ObjectMeta metadata, PriorityLevelConfigurationSpec spec, PriorityLevelConfigurationStatus status) {
        super();
    ...
    @JsonIgnore
    public PriorityLevelConfigurationBuilder edit() {
        return new PriorityLevelConfigurationBuilder(this);
    }

    @JsonIgnore
    public PriorityLevelConfigurationBuilder toBuilder() {
        return edit();
    }
