...
public class UserTag implements Editable<UserTagBuilder>, KubernetesResource
{
    ...
    public UserTag(String key, String parentID, String value) {
        super();
        this.key = key;
    ...
    public UserTagBuilder edit() {
        return new UserTagBuilder(this);
    }
