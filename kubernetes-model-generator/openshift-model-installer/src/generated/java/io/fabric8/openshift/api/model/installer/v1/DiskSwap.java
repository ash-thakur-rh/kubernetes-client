...
public class DiskSwap implements Editable<DiskSwapBuilder>, KubernetesResource
{
    ...
    public DiskSwap(String platformDiskID) {
        super();
    ...
    @JsonIgnore
    public DiskSwapBuilder edit() {
        return new DiskSwapBuilder(this);
    }

    @JsonIgnore
    public DiskSwapBuilder toBuilder() {
        return edit();
    }
